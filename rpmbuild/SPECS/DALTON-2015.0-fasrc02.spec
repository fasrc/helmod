...
#
%description
openmp build.  The Dalton2015 suite consists of two separate executables, Dalton and LSDalton. The Dalton code is a powerful tool for a wide range of molecular properties at different levels of theory, whereas LSDalton is a linear-scaling HF and DFT code suitable for large molecular systems, now also with some CCSD capabilites.
...
%define buildcomments Openmp build
...
then
    ...
    ./setup --fc=ifort --cc=icc --cxx=icpc --mkl=sequential --omp  build
fi
