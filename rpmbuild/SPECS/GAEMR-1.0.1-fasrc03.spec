...
%define rundependencies rdp_classifier/2.10.1-fasrc01 rnammer/1.2-fasrc01 python/2.7.13-fasrc01 bwa/0.7.9a-fasrc03 bowtie2/2.3.1-fasrc01 ncbi-blast/2.2.31+-fasrc01  MUMmer/3.23-fasrc04 samtools/1.1-fasrc05 picard/2.9.0-fasrc01
...
cd "$FASRCSW_DEV"/rpmbuild/BUILD
rm -rf pysam-0.10.0
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/pysam-0.10.0.tar.gz
cd pysam-0.10.0
chmod -Rf a+rX,u+w,g-w,o-w .
...
cd "$FASRCSW_DEV"/rpmbuild/BUILD/pysam-0.10.0
python setup.py build
