...
#
%define summary_static ITT's IDL, version 8.3
...
setenv("IDL_HOME",              "/n/sw/idl-8.3")
setenv("LM_LICENSE_FILE",       "27001@rclic1")

prepend_path("PATH",                "/n/sw/idl-8.3/idl83/bin")
prepend_path("PATH",                "/n/sw/idl-8.3/envi/bin")
prepend_path("PATH",                "/n/sw/idl-8.3/envi/classic/bin")
EOF
