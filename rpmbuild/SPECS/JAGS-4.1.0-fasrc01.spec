...
#
%define summary_static Just Another Gibbs Sampler 
...
# applicable
#
URL:http://downloads.sourceforge.net/project/mcmc-jags/JAGS/4.x/Source/JAGS-4.1.0.tar.gz 
...
%define requestor Katy McKeough <kathrynmckeough@g.harvard.edu>
