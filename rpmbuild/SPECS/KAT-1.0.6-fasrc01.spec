...
# applicable
#
URL: https://github.com/TGAC/KAT/archive/Release-1.0.6.tar.gz
...
%define builddependencies jellyfish/1.1.11-fasrc01 seqan/1.4.2-fasrc01 
%define rundependencies %{builddependencies}
%define buildcomments Jellyfish is picked up via the PKG_CONFIG_PATH
%define requestor Shokai Yu <shoukaiyu@hsph.harvard.edu>
