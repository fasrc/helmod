...
# applicable
#
URL: https://github.com/OpenImageIO/oiio/archive/Release-1.5.10.tar.gz
Source: OpenImageIO-1.5.10.tar.gz
...
%define rundependencies  openexr/2.2.0-fasrc02 boost/1.54.0-fasrc02 ilmbase/2.2.0-fasrc02
...
cmake -DCMAKE_INSTALL_PREFIX=%{_prefix} -DCMAKE_INCLUDE_PATH:STRING="$OPENEXR_INCLUDE;$BOOST_INCLUDE;$ILMBASE_INCLUDE" -DCMAKE_LIBRARY_PATH:STRING="$OPENEXR_LIB;$BOOST_LIB;$ILMBASE_LIB" .. 
