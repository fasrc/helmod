...
#
%define summary_static PeakSeq is a program for identifying and ranking peak regions in ChIP-Seq experiments. 
...
# applicable
#
URL: http://archive.gersteinlab.org/proj/PeakSeq/Scoring_ChIPSeq/Code/C/PeakSeq_1.31.zip
