...
#wget http://downloads.sourceforge.net/project/rdkit/rdkit/Q1_2014/RDKit_2014_03_1.tgz
...
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/%{name}_%{version}.tgz
cd %{name}_%{version}
...
mv %{buildroot}/"$FASRCSW_DEV"/rpmbuild/BUILD/RDKit_2014_03_1 %{buildroot}/%{_prefix}
