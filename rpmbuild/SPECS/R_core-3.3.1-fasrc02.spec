...
# applicable
#
URL: http://archive.linux.duke.edu/cran/src/base/R-3/R-3.3.1.tar.gz
...
%define buildcomments Built as a compiler dependent module
%define requestor Matthew Ploenzke <ploenzke@g.harvard.edu>
%define requestref RCRT:109731
