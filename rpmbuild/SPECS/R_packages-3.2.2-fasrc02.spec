...
%define builddependencies R_core/3.2.2-fasrc02 gsl/1.16-fasrc03 netcdf/3.6.3-fasrc02 hdf5/1.8.12-fasrc06
...
SHLIB_LD=mpicc
EOF
echo 'install.packages("Rmpi", lib="%{_prefix}", repos="http://cran.us.r-project.org", configure.args=c("--with-Rmpi-include=${MPI_HOME}/include --with-Rmpi-libpath=${MPI_HOME}/lib --with-Rmpi-type=${RMPI_TYPE}"), configure.vars=c("CPPFLAGS=-I${MPI_HOME}/include LDFLAGS=-L${MPI_HOME}/lib"))' | R --vanilla
