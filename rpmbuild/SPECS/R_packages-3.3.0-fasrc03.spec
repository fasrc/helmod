...
%define builddependencies R_core/%{version}-%{release_short} netcdf/4.3.2-fasrc03 hdf5/1.8.12-fasrc08 gsl/1.16-fasrc02
%define rundependencies %{builddependencies}
%define buildcomments Built as an MPI module
%define requestor Eric Dunipace
%define requestref RCRT:115273
...
SHLIB_LD=mpicc
EOF
echo 'install.packages("Rmpi", lib="%{_prefix}", repos="http://cran.us.r-project.org", configure.args=c("--with-Rmpi-include=${MPI_HOME}/include --with-Rmpi-libpath=${MPI_HOME}/lib --with-Rmpi-type=${RMPI_TYPE}"), configure.vars=c("CPPFLAGS=\"-DMPI2 -I${MPI_HOME}/include\" LDFLAGS=-L${MPI_HOME}/lib"))' | R --vanilla
