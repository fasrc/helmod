...
#
%define summary_static SSPACE standard is a stand-alone program for scaffolding pre-assembled contigs using NGS paired-read data.
...
# applicable
#
URL: https://www.baseclear.com/genomics/bioinformatics/basetools/SSPACE
