...
#
%define summary_static Sphinx version 1.3.1
...
(or other documents consisting of multiple reStructuredText sources), written by Georg Brandl. 
...
sudo chown -R pkrastev:rc_admin "/n/sw/fasrcsw/apps/Core/Sphinx"

export PYTHONPATH=/n/sw/fasrcsw/apps/Core/Sphinx/1.3.1-fasrc01/lib/python2.7/site-packages:${PYTHONPATH}
...
rm -r "/n/sw/fasrcsw/apps/Core/Sphinx"
...
prepend_path("CPATH",              "%{_prefix}/lib/python2.7/site-packages/docutils-0.12-py2.7.egg/docutils/parsers/rst/include")
prepend_path("FPATH",              "%{_prefix}/lib/python2.7/site-packages/docutils-0.12-py2.7.egg/docutils/parsers/rst/include")
