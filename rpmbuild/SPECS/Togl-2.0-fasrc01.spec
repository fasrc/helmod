...
#
%define summary_static Togl is a Tk widget for OpenGL rendering
...
# applicable
#
URL: http://downloads.sourceforge.net/project/togl/Togl/2.0/Togl2.0-src.tar.gz
...
setenv("TOGL_HOME",                "%{_prefix}")
setenv("TOGL_INCLUDE",             "%{_prefix}/include")
setenv("TOGL_LIB",                 "%{_prefix}/lib64")
