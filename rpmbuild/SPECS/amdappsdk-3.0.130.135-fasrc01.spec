...
#
%define summary_static AMD OpenCL™ Accelerated Parallel Processing SDK
...
setenv("AMDAPPSDKROOT",             "%{_prefix}/AMDAPPSDK-3.0")

prepend_path("PATH",                "%{_prefix}/AMDAPPSDK-3.0/bin/x86_64")
prepend_path("CPATH",               "%{_prefix}/AMDAPPSDK-3.0/include")
prepend_path("LD_LIBRARY_PATH",     "%{_prefix}/AMDAPPSDK-3.0/lib/x86_64")
prepend_path("LIBRARY_PATH",        "%{_prefix}/AMDAPPSDK-3.0/lib/x86_64")
EOF
