...
#
%define summary_static Cairo graphics library
...
%define requestor Kate Dagon <kdagon@fas.harvard.edu>
...
setenv("CAIRO_HOME",               "%{_prefix}")
setenv("CAIRO_INCLUDE",            "%{_prefix}/include")
setenv("CAIRO_LIB",                "%{_prefix}/lib64")
