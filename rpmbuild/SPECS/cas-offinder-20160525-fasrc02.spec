...
%define builddependencies cmake/2.8.12.2-fasrc01 cuda/7.5-fasrc01
%define rundependencies  cuda/7.5-fasrc01
%define buildcomments GPU only
...
cmake -DCMAKE_INSTALL_PREFIX=%{_prefix} -DOPENCL_LIBRARY=${CUDA_LIB}/libOpenCL.so -DOPENCL_INCLUDE_DIR=/usr/local/cuda-7.5/targets/x86_64-linux/include  ..
make
