...
#
%define summary_static CASA, the Common Astronomy Software Applications package, is being developed with the primary goal of supporting the data post-processing needs of the next generation of radio astronomical telescopes such as ALMA and VLA. 
...
# applicable
#
URL: https://svn.cv.nrao.edu/casa/linux_distro/release/el6/casa-release-4.4.0-el6.tar.gz 
Source: %{name}-release-%{version}-el6.tar.gz
...
%define buildcomments Tarball was unpacked and cleaned of .svn dirs and files
%define requestor 	Charles Hull <chat.hull@cfa.harvard.edu>
%define requestref RCRT:88479

# apptags
# For aci-ref database use aci-ref-app-category and aci-ref-app-tag namespaces and separate tags with a semi-colon
# aci-ref-app-category:Programming Tools; aci-ref-app-tag:Compiler
%define apptags aci-ref-app-category:Application; aci-ref-app-tag:Astronomy
...
rm -rf %{name}-release-%{version}-el6
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/%{name}-release-%{version}-el6.tar.*
cd %{name}-release-%{version}-el6
...
umask 022
cd "$FASRCSW_DEV"/rpmbuild/BUILD/%{name}-release-%{version}-el6
