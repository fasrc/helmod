...
%define buildcomments Remove mkl mkl-service hdf5 h5py mpich2 mpi4py. Include pyraf
...
# Pyraf install
%{_prefix}/x/bin/conda remove --yes astropy
%{_prefix}/x/bin/pip install astropy==1.2.1
%{_prefix}/x/bin/pip install pyraf
