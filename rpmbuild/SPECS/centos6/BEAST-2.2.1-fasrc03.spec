...
# applicable
#
URL: https://github.com/CompEvol/beast2/releases/download/v2.2.1/BEAST.v2.2.1.Linux.tgz 
...
%define buildcomments Added beagle as a runtime dependency
%define requestor Rosa Fernandex-Garcia <rfernandezgarcia@g.harvard.edu>
...
#sed -i 's@beast.app.beastapp.BeastLauncher@beast.app.beastapp.BeastLauncher -threads $SLURM_NTASKS@' bin/beast
