...
#
%define summary_static BayesPhylogenies is a general package for inferring phylogenetic trees using Bayesian Markov Chain Monte Carlo (MCMC) or Metropolis-coupled Markov chain Monte Carlo (MCMCMC) methods.
...
# applicable
#
URL: /n/home01/zxi/BayesPhylogenies-2.0.2.tar.gz
...
umask 022
cd "$FASRCSW_DEV"/rpmbuild/BUILD/BP.2.0.2
mpicc *.c -O3 -DMPI_ENABLED -o BayesPhylogenies
...
cp BayesPhylogenies %{buildroot}%{_prefix}/bin
