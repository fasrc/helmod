...
#
%define summary_static ImageMagick is a software suite to create, edit, and compose bitmap images.
...
#
#ftp://mirror.aarnet.edu.au/pub/imagemagick/ImageMagick-6.8.8-4.tar.gz
