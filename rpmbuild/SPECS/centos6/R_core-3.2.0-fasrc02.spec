...
#http://cran.at.r-project.org/src/base/R-3/R-3.2.0.tar.gz
...
%define requestor Kolea Zimmerman <kzimmerman@fas.harvard.edu>
%define requestref RCRT:87012
...
# Have to update the Rinterface.h file so that Rcpp stuff will work
