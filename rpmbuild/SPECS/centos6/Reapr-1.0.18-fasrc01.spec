...
%define builddependencies perl-modules/5.10.1-fasrc11 R/3.2.0-fasrc01
%define rundependencies %{builddependencies}
%define buildcomments Reapr needs to be built in place.  This just points to it and provides perl / R
...
setenv("REAPR_HOME",                "/n/sw/Reapr_1.0.18")
prepend_path("PATH",                "/n/sw/Reapr_1.0.18")
EOF
