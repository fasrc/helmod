...
# install GCC and CPP wrappers

WRAPPERS_DIR="$FASRCSW_DEV"/rpmbuild/BUILD/%{name}-%{version}/tools/cpp/wrappers
mkdir -p $WRAPPERS_DIR

CPP_WRAPPER=$WRAPPERS_DIR/cpp.sh
GCC_WRAPPER=$WRAPPERS_DIR/gcc.sh

wrappers=( $GCC_WRAPPER $CPP_WRAPPER )
...
+  tool_path { name: "cpp" path: "${CPP_WRAPPER}" }
