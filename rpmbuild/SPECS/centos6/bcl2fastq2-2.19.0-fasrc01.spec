...
# applicable
#
URL: https://support.illumina.com/content/dam/illumina-support/documents/downloads/software/bcl2fastq/bcl2fastq2-v2.19.0.tar.gz
Source: bcl2fastq2-v2.19.0.tar.gz
...
rm -rf bcl2fastq  
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/%{name}-v%{version}.tar.gz
cd bcl2fastq
