...
#
%define summary_static BioLite is a Python/C++ framework for implementing bioinformatics pipelines for Next-Generation Sequencing (NGS) data, in particular pair-end Illumina data.
...
pip install --install-option="--prefix=%{buildroot}/%{_prefix}" 'biolite'
