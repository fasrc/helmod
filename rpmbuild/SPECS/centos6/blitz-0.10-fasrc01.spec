...
#
%define summary_static Blitz++ is a C++ class library for scientific computing which provides performance on par with Fortran 77/90.
...
#
#ftp://ftp.mirrorservice.org/sites/distfiles.macports.org/blitz/blitz-0.10.tar.gz
...
setenv("BLITZ_HOME",                "%{_prefix}")
setenv("BLITZ_INCLUDE",             "%{_prefix}/include")
setenv("BLITZ_LIB",                 "%{_prefix}/lib64")
prepend_path("LD_LIBRARY_PATH",     "%{_prefix}/lib64")
prepend_path("LIBRARY_PATH",        "%{_prefix}/lib64")
prepend_path("CPATH",               "%{_prefix}/include")
prepend_path("FPATH",               "%{_prefix}/include")
prepend_path("CPATH",               "%{_prefix}/include/blitz")
prepend_path("FPATH",               "%{_prefix}/include/blitz")
prepend_path("CPATH",               "%{_prefix}/include/random")
prepend_path("FPATH",               "%{_prefix}/include/random")
EOF
