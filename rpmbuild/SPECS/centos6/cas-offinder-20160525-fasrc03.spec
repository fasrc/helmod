...
%define buildcomments GPU only.  Built within the new CUDA system
...
cmake -DCMAKE_INSTALL_PREFIX=%{_prefix} -DOPENCL_LIBRARY=${CUDA_LIB}/libOpenCL.so -DOPENCL_INCLUDE_DIR=${CUDA_HOME}/targets/x86_64-linux/include  ..
make
