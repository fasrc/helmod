...
%define builddependencies netcdf/4.3.2-fasrc03 proj/4.8.0-fasrc01 udunits/2.2.18-fasrc01 hdf5/1.8.12-fasrc04 libxml2/2.7.8-fasrc02 grib_api/1.20.0-fasrc01
%define rundependencies %{builddependencies}
%define buildcomments No MPI.  grib_api support added.
...
./configure --prefix=%{_prefix} \
    ...
    --with-jasper=$JASPER_HOME \
    --with-grib_api=$GRIB_API_HOME 
