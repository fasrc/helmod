...
#
%define summary_static CEGMA (Core Eukaryotic Genes Mapping Approach) is a pipeline for building a set of high reliable set of gene annotations in virtually any eukaryotic genome.
...
%define rundependencies wise/2.2.3rc7-fasrc01 geneid/1.4.4-fasrc01 hmmer/3.1b1-fasrc01 ncbi-blast/2.2.29+-fasrc01
...
%define apptags aci-ref-app-category:Applications aci-reg-app-tag:Sequence annotation
...
setenv("CEGMA_HOME",                  "%{_prefix}")
setenv("CEGMA",                       "%{_prefix}")
setenv("CEGMATMP",                    "/scratch/")
