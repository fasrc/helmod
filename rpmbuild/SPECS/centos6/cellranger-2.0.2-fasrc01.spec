...
# applicable
#
URL: https://s3-us-west-2.amazonaws.com/10x.downloads/cellranger-2.0.2.tar.gz
...
prepend_path("PATH",                "%{_prefix}/martian-cs/2.2.2/bin")
...
prepend_path("PYTHONPATH",          "%{_prefix}/martian-cs/2.2.2/adapters/python")
