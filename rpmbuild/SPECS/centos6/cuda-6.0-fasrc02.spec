...
%define buildcomments Activation module for CUDA libraries.  Doesn't actually install them, but updates PATH, LD_LIBRARY_PATH, etc. Updates MODULEPATHS for FASRCSW_CUDA system.
