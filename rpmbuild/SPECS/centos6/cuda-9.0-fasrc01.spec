...
for i in string.gmatch("%{rundependencies}","%%S+") do
    if mode()=="load" then
        assert(os.execute("test -d /usr/local/cuda-9.0")==0,"Cuda 9.0 is not available from /usr/local/cuda-9.0")
    end
end
...
setenv("CUDA_LIB",                  "/usr/local/cuda-9.0/lib64")
setenv("CUDA_INCLUDE",              "/usr/local/cuda-9.0/include")
prepend_path("PATH",                "/usr/local/cuda-9.0/bin")
prepend_path("CPATH",               "/usr/local/cuda-9.0/include")
prepend_path("FPATH",               "/usr/local/cuda-9.0/include")
prepend_path("LD_LIBRARY_PATH",     "/usr/local/cuda-9.0/lib")
prepend_path("LIBRARY_PATH",        "/usr/local/cuda-9.0/lib")
prepend_path("LD_LIBRARY_PATH",     "/usr/local/cuda-9.0/lib64")
prepend_path("LIBRARY_PATH",        "/usr/local/cuda-9.0/lib64")
