...
#
%define summary_static EggLib is a C++/Python library and program package for evolutionary genetics and genomics.
...
# applicable
#
URL: http://downloads.sourceforge.net/project/egglib/current/egglib-cpp-2.1.8.tar.gz
...
if mode()=="load" then
	...
	if not isloaded("bio++/2.1.0-fasrc01") then
		load("bio++/2.1.0-fasrc01")
	end
end

---- environment changes (uncomment what's relevant)
setenv("EGGLIB_HOME",              "%{_prefix}")
setenv("EGGLIB_LIB",               "%{_prefix}/lib64")
setenv("EGGLIB_INCLUDE",           "%{_prefix}/include")
