...
# applicable
#
URL: http://pkgs.fedoraproject.org/repo/pkgs/glib2/glib-2.27.93.tar.gz
...
%define builddependencies zlib/1.2.8-fasrc06 dbus/1.11.2-fasrc01
%define rundependencies %{builddependencies}
%define buildcomments built for gstreamer
...
setenv("GLIB_LIB",                 "%{_prefix}/lib")
prepend_path("PATH",               "%{_prefix}/bin")
prepend_path("CPATH",              "%{_prefix}/lib/glib-2.0/include")
prepend_path("CPATH",              "%{_prefix}/include")
prepend_path("FPATH",              "%{_prefix}/lib/glib-2.0/include")
