...
%define requestor Nick Patterson <nickp@broadinstitute.org>
%define requestref RCRT:117647
...
./configure --prefix=%{_prefix} \
	...
	--infodir=%{_prefix}/share/info \
        --enable-python=no --enable-perl=no --enable-php=no \
        --enable-tcl=no --enable-lua=no --enable-ruby=no
