...
#
%define summary_static HDF5 Data Storage Package
...
#
#http://...FIXME...
Source: http://www.hdfgroup.org/ftp/HDF5/current/src/hdf5-1.8.12.tar.gz
...
#
%description
HDF5 is a common package used for storing and packaging data.  HDF5 files can be read in to many vizualization applications and is good for 
structured and unstructured data. HDF5 also supports parallel I/O from MPI jobs.
...
%configure CC=mpicc CXX=mpicxx FC=mpif90 --enable-fortran --enable-parallel
make
