...
#
%define summary_static HMMER v2.3.2
...
# applicable
#
URL: ftp://selab.janelia.org/pub/software/hmmer/2.3.2/hmmer-2.3.2.tar.gz
...
./configure --prefix=%{buildroot}%{_prefix} --enable-threads
