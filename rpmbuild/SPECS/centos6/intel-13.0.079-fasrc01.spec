...
#
%define summary_static Intel Cluster Studio XE 2013 High Performance MPI Hybrid Cluster Development Suite
...
prepend_path("CPATH",               "%{_prefix}/composerxe/include")
