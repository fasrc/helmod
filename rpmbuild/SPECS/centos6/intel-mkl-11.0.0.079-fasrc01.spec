...
setenv("MKLROOT",                   "%{_prefix}")

prepend_path("PATH",                "%{_prefix}/bin/intel64")
prepend_path("LD_LIBRARY_PATH",     "%{_prefix}/lib/intel64")
prepend_path("LIBRARY_PATH",        "%{_prefix}/lib/intel64")
prepend_path("MANPATH",             "%{_prefix}/man/en_US")
prepend_path("CPATH",               "%{_prefix}/include")
prepend_path("FPATH",               "%{_prefix}/include")
prepend_path("CPATH",               "%{_prefix}/include/intel64/lp64")
prepend_path("FPATH",               "%{_prefix}/include/intel64/lp64")
EOF
