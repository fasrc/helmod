...
%define buildcomments Created for holyseasgpus.  This is a CUDA build that creates the lmp_cuda executable.  It includes the misc, user-misc, kokkos, and user-reaxc sub packages.  Built with the new CUDA system
