...
# applicable
#
URL: https://github.com/evaleev/libint/releases/download/v2.1.0/libint-2.1.0-stable.tgz
Source: %{name}-%{version}-stable.tgz
...
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/%{name}-%{version}-stable.tgz
