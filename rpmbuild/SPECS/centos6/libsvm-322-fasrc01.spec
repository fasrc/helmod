...
#
%define summary_static Libsvm is a simple, easy-to-use, and efficient software for SVM classification and regression.
...
setenv("LIBSVM_HOME",               "%{_prefix}")
setenv("LIBSVM_LIB",                "%{_prefix}")
setenv("LIBSVM_INCLUDE",            "%{_prefix}")
