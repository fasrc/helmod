...
%define builddependencies RepeatMasker/4.0.5-fasrc03 ncbi-blast/2.2.30+-fasrc01 perl-modules/5.10.1-fasrc12 snap/2013.11.29-fasrc01 exonerate/2.4.0-fasrc01 augustus/3.0.3-fasrc02
%define rundependencies %{builddependencies}
%define buildcomments Manual install instead of Build.pl install since it would not respect PREFIX or --install_base
%define requestor Jeffrey DaCosta <jdacosta@oeb.harvard.edu>
%define requestref RCRT:92345
...
cp -r blib/config-x86_64-linux-thread-multi-5.010001 %{buildroot}%{_prefix}/perl
