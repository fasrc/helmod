...
Source: %{name}_%{version}_3.tar.gz
...
%define buildcomments Appears to be picking up the mpicc in Anaconda.
...
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/%{name}_%{version}_3.tar.*
cd %{name}_%{version}
