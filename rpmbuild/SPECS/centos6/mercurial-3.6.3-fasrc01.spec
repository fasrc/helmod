...
# applicable
#
URL: http://mercurial.selenic.com/release/mercurial-3.6.3.tar.gz
...
%define requestor Dylan Nelson <dnelson@MPA-Garching.MPG.DE>
%define requestref RCRT:96125
...
cd ..
tar xvf "$FASRCSW_DEV/rpmbuild/SOURCES/docutils-0.12.tar.gz" 
cd docutils-0.12 && python setup.py install --prefix=%{_prefix} --root=%{buildroot}
cd ../%{name}-%{version}
...
prepend_path("CPATH",              "%{_prefix}/lib/python2.7/site-packages/docutils/parsers/rst/include")
prepend_path("FPATH",              "%{_prefix}/lib/python2.7/site-packages/docutils/parsers/rst/include")
