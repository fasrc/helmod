...
# applicable
#
URL: http://download.mono-project.com/sources/mono/mono-4.6.0.182.tar.bz2
Source: %{name}-%{version}.182.tar.bz2
...
rm -rf %{name}-%{version}
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/%{name}-%{version}.182.tar.*
cd %{name}-%{version}
