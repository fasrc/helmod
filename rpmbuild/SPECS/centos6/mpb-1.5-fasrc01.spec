...
%define builddependencies libctl/3.2.2-fasrc01 hdf5/1.8.12-fasrc06 fftw/3.3.4-fasrc06
...
./configure --prefix=%{_prefix} --with-mpi --enable-shared --with-libctl=${LIBCTL_HOME}/share/libctl \
#	--program-prefix= \
#	--exec-prefix=%{_prefix} \
#	--bindir=%{_prefix}/bin \
