...
%define builddependencies cmake/2.8.12.2-fasrc01 ffmpeg/2.3.2-fasrc01 python/2.7.6-fasrc01
%define rundependencies ffmpeg/2.3.2-fasrc01 python/2.7.6-fasrc01
%define buildcomments This build is fairly tightly tied to Anaconda. Many of the graphics libraries are linked from there.
%define requestor David Zwicker <dzwicker@seas.harvard.edu>
%define requestref RCRT:91601
...
mkdir build
cd build
cmake -DCMAKE_BUILD_TYPE=RELEASE -DCMAKE_INSTALL_PREFIX=%{_prefix} -DCMAKE_INCLUDE_PATH=$PYTHON_HOME/include -DCMAKE_LIBRARY_PATH=$PYTHON_HOME/lib ..
