...
#
%define summary_static Parallel netCDF version 1.5.0
...
# applicable
#
URL: http://cucis.ece.northwestern.edu/projects/PnetCDF/Release/parallel-netcdf-1.5.0.tar.gz
...
%define buildcomments This app insists on writing directly to the prefix.  Acquiesce, and hack a symlink, IN THE PRODUCTION DESTINATION (yuck), back to our where we want it to install in our build environment, and then remove the symlink.  Note that this will only work for the first build of this NAME/VERSION/RELEASE/TYPE 
