...
#
%define summary_static PETSc version 3.4.5
...
./configure --prefix=%{_prefix} --with-mpi-dir=$MPI_HOME --with-metis-dir=$METIS_HOME --with-mpi4py --with-numpy --with-fftw-dir=$FFTW_HOME --with-boost-dir=$BOOST_HOME --with-netcdf-dir=$NETCDF_HOME --with-hdf5-dir=$HDF5_HOME
