...
#
%define summary_static PHAST is a freely available software package for comparative and evolutionary genomics.
...
# applicable
#
URL: http://compgen.cshl.edu/phast/downloads/phast.v1_4.tgz
Source: %{name}.v1_4.tgz
...
rm -rf %{name}
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/%{name}.v1_4.tgz
cd %{name}
...
cd ../src/lib
make CLAPACKPATH=$CLAPACK_HOME PLAT=_LINUX
cd ..
make CLAPACKPATH=$CLAPACK_HOME PLAT=_LINUX
...
setenv("PHAST_HOME",              "%{_prefix}")
prepend_path("PATH",              "%{_prefix}/bin")
prepend_path("MANPATH",           "%{_prefix}/doc/man")
EOF
