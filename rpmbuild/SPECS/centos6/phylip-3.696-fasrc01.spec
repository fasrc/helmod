...
#
%define summary_static PHYLIP is a free package of programs for inferring phylogenies.
...
sed -i -e 's?^CFLAGS.*?CFLAGS = -O3 -DUNX -fomit-frame-pointer?' \
       -e 's?^EXEDIR.*?EXEDIR=%{buildroot}%{_prefix}?' Makefile.unx
