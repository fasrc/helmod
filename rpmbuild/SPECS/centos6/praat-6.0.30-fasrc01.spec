...
#
%define summary_static Praat: Doing Phonetics By Computer
...
+CFLAGS = -DNO_GUI -DNO_NETWORK -D_FILE_OFFSET_BITS=64 -DUNIX -Dlinux \`pkg-config --cflags glib-2.0 pango cairo\` -Werror=missing-prototypes -Werror=implicit -Wreturn-type -Wunused -Wunused-parameter -Wuninitialized -O3 -g1 -pthread
...
sed -i 's/praat_nogui/praat/g' makefile.defs
...
cp praat %{buildroot}/%{_prefix}/bin/
