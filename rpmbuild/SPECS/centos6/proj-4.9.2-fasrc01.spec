...
#
%define summary_static PROJ.4 - Cartographic Projections Library
...
wget https://github.com/OSGeo/proj.4/blob/master/nad/proj_def.dat -O %{buildroot}/%{_prefix}/lib64/proj_def.dat
