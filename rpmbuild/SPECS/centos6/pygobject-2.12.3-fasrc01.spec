...
#
%define summary_static Python Bindings for GLib/GObject/GIO/GTK+ 
...
# applicable
#
URL: http://ftp.gnome.org/pub/GNOME/sources/pygobject/2.12/pygobject-2.12.3.tar.gz
...
prepend_path("PYTHONPATH",         "%{_prefix}/lib/python2.7/site-packages/gtk-2.0")
EOF
