...
Source: qt-everywhere-opensource-src-5.9.2.tar.xz
...
%define builddependencies gcc/7.1.0-fasrc01 python/3.6.0-fasrc01
...
# HELMOD build failed.  Installed manually.
# ./configure --prefix=/n/sw/fasrcsw/apps/Core/qt/5.9.2-fasrc02 -opensource -confirm-license -skip qtgamepad -nomake tests -sse2 -no-avx -no-avx2 -no-avx512 -c++std c++11
