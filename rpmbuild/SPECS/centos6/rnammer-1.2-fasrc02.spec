...
%define rundependencies perl-modules/5.10.1-fasrc08 hmmer/2.3.2-fasrc01
%define buildcomments Repackaged source code for easier building; Added Trinotate hack (see https://trinotate.github.io/#SoftwareRequired)
%define requestor Eva Fischer <evafischer@fas.harvard.edu>
%define requestref RCRT:109756
