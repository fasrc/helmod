...
#
%define summary_static RStudio version 0.98.1103
...
#
%description
RStudio is an integrated development environment (IDE) for R. This module has been built by Plamen G. Krastev.
...
%define builddependencies boost/1.55.0-fasrc03 R/3.2.0-fasrc01 cmake/2.8.12.2-fasrc01
%define rundependencies boost/1.55.0-fasrc03 R/3.2.0-fasrc01 
%define buildcomments Built against R/3.2.0
%define requestor Pascal Noel <noel@fas.harvard.edu>
%define requestref RCRT:88756 
