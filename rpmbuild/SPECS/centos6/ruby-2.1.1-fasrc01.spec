...
prepend_path("LD_LIBRARY_PATH",    "%{_prefix}/lib64/ruby/2.1.0/rake/lib")
prepend_path("LD_LIBRARY_PATH",    "%{_prefix}/share/ri/2.1.0/system/lib")
prepend_path("LIBRARY_PATH",       "%{_prefix}/lib64/ruby/2.1.0/rake/lib")
prepend_path("LIBRARY_PATH",       "%{_prefix}/share/ri/2.1.0/system/lib")
