...
#
%define summary_static Command line tool for managing Amazon S3 and CloudFront services
...
# applicable
#
URL: https://github.com/s3tools/s3cmd/releases/download/v1.6.1/s3cmd-1.6.1.tar.gz
