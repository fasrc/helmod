...
#
%define summary_static SciPy version 0.15.1
...
#
%description
SciPy: Scientific Library for Python. An open-source software for mathematics, science, and engineering. 
This module has been built with Intel compiler and MKL by Plamen G. Krastev.
...
python setup.py config --compiler=intelem --fcompiler=intelem build_clib \
                       --compiler=intelem --fcompiler=intelem build_ext  \
                       --compiler=intelem --fcompiler=intelem build install --prefix=%{_prefix}
