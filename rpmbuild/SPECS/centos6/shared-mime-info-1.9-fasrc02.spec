...
#
%define summary_static The shared-mime-info package contains the core database of common types and the update-mime-database command used to extend it. It requires glib2 to be installed for building the update command.
...
setenv("SHARED_MIME_HOME",                 "%{_prefix}")
