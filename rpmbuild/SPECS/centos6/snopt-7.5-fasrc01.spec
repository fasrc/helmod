...
#
%define summary_static SNOPT Optimization Software.
Summary: %{summary_static}

#
# enter the url from where you got the source; change the archive suffix if 
# applicable
# See RT96167 as Kumar provided the source and license.
URL: http://www.sbsi-sol-optimize.com/asp/sol_products_snopt_desc.htm
...
setenv("SNOPT_HOME",       "%{_prefix}")
setenv("SNOPT_INCLUDE",	   "%{_prefix}/include")
setenv("SNOPT_LIB",	       "%{_prefix}/lib64")
