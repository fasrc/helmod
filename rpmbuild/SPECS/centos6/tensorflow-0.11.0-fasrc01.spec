...
#
%define summary_static TensorFlow
...
%define rundependencies gcc/4.9.3-fasrc01 Anaconda/2.5.0-fasrc01 cudnn/7.0-fasrc01
...
---
>     url = "http://www-us.apache.org/dist/avro/avro-1.8.2/cpp/avro-cpp-1.8.2.tar.gz",
>     sha256 = "5328b913882ee5339112fa0178756789f164c9c5162e1c83437a20ee162a3aab",
>     strip_prefix = "avro-cpp-1.8.2",
EOF
...
# remove testonly=1 to get rid of a weird bazel error
sed -i -e '/testonly = 1,/d' tensorflow/python/BUILD
