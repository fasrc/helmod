...
#
%define summary_static TensorFlow version 0.8.0
...
Build from git on 5-23-2016 using commit: 175a28cf12e7002827245281c2c9f36d93b37be7
Built from git on 03-30-2016 using commit: 16254e7
...
%define rundependencies Anaconda/2.5.0-fasrc01
...
cat <<EOF | patch tensorflow/tensorflow.bzl
529c529
...
bazel build -c opt //tensorflow/tools/pip_package:build_pip_package --verbose_failures --spawn_strategy=standalone --genrule_strategy=standalone --jobs 4
...
pip install --target=%{site_packages} ./wheels/%{name}-0.8.0-py2-none-any.whl
