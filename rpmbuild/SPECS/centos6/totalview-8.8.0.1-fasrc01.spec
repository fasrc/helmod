...
#
%define summary_static Totalview v.8.8.0-1, Dynamic source code and memory debugging for C, C++ and Fortran applications.
...
%define apptags aci-ref-app-category:Programming Tools; aci-ref-app-tag:Debugging
...
#
%description
Totalview v.8.8.0-1, Dynamic source code and memory debugging for C, C++ and Fortran applications.
...
prepend_path("PATH",                "/n/sw/totalview.8.8.0-1/toolworks/totalview.8.8.0-1/bin")
prepend_path("LD_LIBRARY_PATH",     "/n/sw/totalview.8.8.0-1/toolworks/totalview.8.8.0-1/lib")
prepend_path("MANPATH",             "/n/sw/totalview.8.8.0-1/toolworks/totalview.8.8.0-1/man")
EOF
