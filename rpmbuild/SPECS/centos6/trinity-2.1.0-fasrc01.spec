...
# applicable
#
URL: https://github.com/trinityrnaseq/trinityrnaseq/archive/v2.1.0.tar.gz
...
%define rundependencies trinityrnaseq/2.1.0-fasrc01
...
#
%description
Alias for trinityrnaseq/2.1.0-fasrc01
%prep
%build
%install
