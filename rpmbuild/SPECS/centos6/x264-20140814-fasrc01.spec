...
# applicable
#
URL: ftp://ftp.videolan.org/pub/videolan/x264/snapshots/x264-snapshot-20140814-2245-stable.tar.bz2
Source: x264-snapshot-20140814-2245-stable.tar.bz2
...
%define builddependencies yasm/1.3.0-fasrc01 
%define rundependenciesa %{nil}
...
rm -rf x264-snapshot-20140814-2245-stable
tar xjvf "$FASRCSW_DEV"/rpmbuild/SOURCES/x264-snapshot-20140814-2245-stable.tar.bz2
cd x264-snapshot-20140814-2245-stable
...
umask 022
cd "$FASRCSW_DEV"/rpmbuild/BUILD/x264-snapshot-20140814-2245-stable
...
umask 022
cd "$FASRCSW_DEV"/rpmbuild/BUILD/x264-snapshot-20140814-2245-stable
echo %{buildroot} | grep -q x264-snapshot-20140814-2245-stable && rm -rf %{buildroot}
