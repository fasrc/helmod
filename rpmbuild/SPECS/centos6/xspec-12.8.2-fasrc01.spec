...
#
%define summary_static An X-Ray Spectral Fitting Package
...
# applicable
#
URL: http://heasarc.gsfc.nasa.gov/FTP/software/lheasoft/release/heasoft-6.16src.tar.gz
Source: heasoft-6.16src.tar.gz
...
#
%description
XSPEC is a command-driven, interactive, X-ray spectral-fitting program, designed to be completely 
detector-independent so that it can be used for any spectrometer. XSPEC has been used to analyze 
data from HEAO-1 A2, Einstein Observatory, EXOSAT, Ginga, ROSAT, BBXRT, ASCA, CGRO, IUE, RXTE, Chandra,
...
rm -rf heasoft-6.16
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/heasoft-6.16src.tar.*
cd heasoft-6.16
...
umask 022
cd "$FASRCSW_DEV"/rpmbuild/BUILD/heasoft-6.16/BUILD_DIR
