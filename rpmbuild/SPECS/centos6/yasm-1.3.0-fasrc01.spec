...
#
%define summary_static Yasm is a complete rewrite of the NASM assembler under the “new” BSD License
...
setenv("YASM_HOME",                "%{_prefix}")
setenv("YASM_INCLUDE",             "%{_prefix}/include")
setenv("YASM_LIB",                 "%{_prefix}/lib64")
