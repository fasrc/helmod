...
%define builddependencies bzip2/1.0.6-fasrc02 fftw/3.3.7-fasrc02
...
test "%{comp_name}" == "intel" &&  ./configure -mpi  intel < my.inp

test "%{comp_name}" == "gcc" && export MKL_HOME=/n/sw/intel-cluster-studio-2017/mkl && ./configure -mpi gnu < my.inp
