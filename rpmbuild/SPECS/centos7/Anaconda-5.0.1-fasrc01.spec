...
# applicable
#
URL: https://repo.continuum.io/archive/Anaconda-5.0.1-Linux-x86_64.sh
...
%define buildcomments Remove hdf5 h5py pyqt and gstreamer.  This removes matplotlib and a number of others
