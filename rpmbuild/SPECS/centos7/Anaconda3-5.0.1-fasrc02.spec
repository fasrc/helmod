...
%define buildcomments This build includes  hdf5 h5py pyqt  gstreamer,  matplotlib and a number of others
...
%defattr(-,root,root,-)
%{_prefix}/*
%exclude %{_prefix}/x/lib/python3.6/
...
%package -n %{name}_lib
Summary: Anaconda python library

%description -n %{name}_lib 
Anaconda python library. Note: this subpackage was created to circumvent size and file number limit in rpm creation

%files -n %{name}_lib 
%defattr(-,root,root,-)
%{_prefix}/x/lib/python3.6
