...
# applicable
#
URL: https://github.com/CompEvol/beast2/releases/download/v2.5.2/BEAST.v2.5.2.Linux.tgz
...
%define requestor souzademedeiros@fas.harvard.edu
%define requestref RCRT:131889
...
---
>   "\$JAVA" -Dlauncher.wait.for.exit=true \$opts -Djava.library.path="\$BEAST_EXTRA_LIBS" -Duser.language=en -cp "\$BEAST_LIB/launcher.jar" beast.app.beastapp.BeastLauncher \$*
57c62
...
---
>   "\$JAVA" -Dlauncher.wait.for.exit=true \$opts -Duser.language=en -cp "\$BEAST_LIB/launcher.jar" beast.app.beastapp.BeastLauncher \$*
