...
# applicable
#
URL: https://github.com/CGAL/cgal/archive/releases/CGAL-5.0.3.tar.gz
...
%define builddependencies cmake/3.17.3-fasrc01 mpfr/3.1.5-fasrc01 boost/1.72.0-fasrc01
%define rundependencies mpfr/3.1.5-fasrc01 boost/1.72.0-fasrc01
...
mv cgal-releases-%{name}-%{version} %{name}-%{version} 
cd %{name}-%{version}
