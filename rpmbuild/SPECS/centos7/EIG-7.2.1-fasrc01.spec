...
#
%define summary_static EIGENSOFT
...
%define builddependencies OpenBLAS/0.2.20-fasrc01 gsl/2.4-fasrc01
...
setenv("EIG_PATH",	 "%{_prefix}/bin")
setenv("EIG_INCLUDE",	 "%{_prefix}/include")
