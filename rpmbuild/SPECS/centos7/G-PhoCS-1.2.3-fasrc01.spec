...
#
%define summary_static G-PhoCS: A Generalized Phylogenetic Coalescent Sampler
...
# applicable
#
URL: http://compgen.cshl.edu/GPhoCS/downloads/GPhoCS-1.2.3.tar.gz
