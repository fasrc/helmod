...
#
%define summary_static ITT's IDL, version 8.7.2
...
setenv("IDL_HOME",              "/n/helmod/apps/centos7/Core/IDL/8.7.2-fasrc01/")
setenv("LM_LICENSE_FILE",       "27001@rclic1")
prepend_path("PATH",                "/n/helmod/apps/centos7/Core/IDL/8.7.2-fasrc01/idl87/bin")
EOF
