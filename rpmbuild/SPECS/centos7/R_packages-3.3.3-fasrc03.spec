#
# R_packages-3.3.3-fasrc01, with 192 packages built, takes about 40 minutes
#
...
%define builddependencies R_core/%{version}-%{release_short} netcdf/4.3.2-fasrc04 hdf5/1.8.12-fasrc09 gsl/1.16-fasrc03 libxml2/2.7.8-fasrc03 nlopt/2.4.2-fasrc03
%define rundependencies %{builddependencies}
%define buildcomments Compiler-specific build.  Nlopt needed due to failed nloptr download.
...
sudo -E LD_LIBRARY_PATH=%{ldp} R CMD INSTALL "$FASRCSW_DEV"/rpmbuild/SOURCES/Rmpi_%{rmpiversion}.tar.gz \
  --configure-args="--with-mpi=$MPI_HOME"
