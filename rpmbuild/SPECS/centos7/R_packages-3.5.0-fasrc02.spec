#
# R_packages-3.4.2-fasrc01, with 192 packages built, takes about 40 minutes
#
...
%define builddependencies R_core/%{version}-%{release_short} netcdf/4.3.2-fasrc04 hdf5/1.8.12-fasrc09 gsl/1.16-fasrc02 nlopt/2.4.2-fasrc01 libxml2/2.7.8-fasrc02
