#
# R_packages-3.6.2-fasrc01, with 192 packages built, takes about 40 minutes
#
...
%define builddependencies R_core/%{version}-%{release_short} hdf5/1.10.6-fasrc02 netcdf/4.7.3-fasrc02 gsl/2.6-fasrc01 nlopt/2.4.2-fasrc01 libxml2/2.7.8-fasrc02
