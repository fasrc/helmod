...
Source0: %{name}-open-4-0-5.tar.gz
Source1: RepeatMaskerLibraries.tar.gz
Source2: Text-Soundex-3.05.tar.gz
#
...
%define builddependencies perl/5.26.1-fasrc01 trf/404-fasrc01 ncbi-rmblastn/2.2.28-fasrc01 hmmer/3.1b2-fasrc01
%define rundependencies %{builddependencies}
%define buildcomments New libraries
...
mkdir -p %{buildroot}/%{_prefix}/Libraries
#make install DESTDIR=%{buildroot}
cp -r * %{buildroot}%{_prefix}
cd %{buildroot}/%{_prefix}/Libraries
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/RepeatMaskerLibraries.tar.gz
...
prepend_path("PERL5LIB",            "%{_prefix}/lib/site_perl/5.26.1/x86_64-linux")
EOF
