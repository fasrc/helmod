...
%define builddependencies perl/5.26.1-fasrc01 python/3.6.3-fasrc02
%define rundependencies %{builddependencies}
%define buildcomments Constructed with Python 3
...
prepend_path("PATH",               "%{_prefix}/lib/python3.6/site-packages")
...
prepend_path("PYTHONPATH",         "%{_prefix}/lib64/python3.6/site-packages")
