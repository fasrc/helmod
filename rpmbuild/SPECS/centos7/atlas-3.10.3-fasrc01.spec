...
Source1: lapack-3.9.0.tar.gz
%define lapack_version 3.9.0
...
../configure --prefix=%{_prefix} \
	--with-netlib-lapack-tarfile="$FASRCSW_DEV"/rpmbuild/SOURCES/lapack-%{lapack_version}.tar.gz \
	-b 64  -t 0  -Fa alg -fPIC  -D c -DPentiumCPS=2500
