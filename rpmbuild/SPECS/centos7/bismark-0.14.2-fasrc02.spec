...
#
%define summary_static bismark version 0.14.2
...
%define builddependencies bowtie2/2.3.2-fasrc02 samtools/1.5-fasrc02
%define rundependencies %{builddependencies}
%define buildcomments Updated bowtie2 and samtools for CentOS 7
