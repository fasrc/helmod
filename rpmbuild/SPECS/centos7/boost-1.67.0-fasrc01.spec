...
rm -rf %{name}_1_67_0
tar xvjf "$FASRCSW_DEV"/rpmbuild/SOURCES/%{name}_1_67_0.tar.*
cd %{name}_1_67_0
...
umask 022
cd "$FASRCSW_DEV"/rpmbuild/BUILD/%{name}_1_67_0
...
umask 022
cd "$FASRCSW_DEV"/rpmbuild/BUILD/%{name}_1_67_0
echo %{buildroot} | grep -q %{name}_1_67_0 && rm -rf %{buildroot}
