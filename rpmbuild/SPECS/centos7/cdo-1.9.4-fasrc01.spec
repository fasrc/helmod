...
%define builddependencies netcdf/4.5.0-fasrc01 proj/4.9.3-fasrc01 udunits/2.2.26-fasrc01 
...
./configure CC=mpicc CXX=mpic++ FC=mpif90 F90=mpif90 --prefix=%{_prefix} \
	--program-prefix= \
	--exec-prefix=%{_prefix} \
	--bindir=%{_prefix}/bin \
