...
# applicable
#
URL: http://cf.10xgenomics.com/releases/cell-exp/cellranger-3.0.1.tar.gz
...
%define requestor Yiqun Wang <yiqunwang@g.harvard.edu>
%define requestref RCRT:130479
...
cat <<EOF > %{buildroot}/%{_prefix}/martian-cs/v3.1.0/jobmanagers/slurm.template
#!/usr/bin/env bash
...
prepend_path("PATH",                "%{_prefix}/martian-cs/v3.1.0/bin")
...
prepend_path("PYTHONPATH",          "%{_prefix}/martian-cs/v3.1.0/adapters/python")
