...
# applicable
#
URL: http://cf.10xgenomics.com/releases/cell-exp/cellranger-3.1.0.tar.gz
...
%define rundependencies bcl2fastq2/2.20.0-fasrc01
%define buildcomments Build for CentOS 7
%define requestor Juerg Straubhaar
...
cat <<EOF > %{buildroot}/%{_prefix}/martian-cs/v3.2.3/jobmanagers/slurm.template
#!/usr/bin/env bash
...
prepend_path("PATH",                "%{_prefix}/martian-cs/v3.2.3/bin")
prepend_path("PATH",                "%{_prefix}/lz4/v1.8.1.2")
...
prepend_path("PATH",                "%{_prefix}/miniconda-cr-cs/4.3.21-miniconda-cr-cs-c10/bin")
prepend_path("PATH",                "%{_prefix}/cellranger-tiny-ref/3.0.0")
prepend_path("PATH",                "%{_prefix}/cellranger-tiny-fastq/3.0.0")
prepend_path("PYTHONPATH",          "%{_prefix}/martian-cs/v3.2.3/adapters/python")
