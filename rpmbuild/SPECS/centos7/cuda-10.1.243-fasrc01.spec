...
Source: %{name}_%{version}_418.87.00_linux.run
...
#chmod +x %{_topdir}/SOURCES/%{name}_%{version}_418.87.00_linux.run
#%{_topdir}/SOURCES/%{name}_%{version}_418.87.00_linux.run --toolkit --installpath="%{_prefix}" --silent
#
