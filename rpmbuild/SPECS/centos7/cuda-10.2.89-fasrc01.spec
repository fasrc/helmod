...
Source: %{name}_%{version}_440.33.01_linux.run
...
%{_topdir}/SOURCES/%{name}_%{version}_440.33.01_linux.run --toolkit --installpath="%{_prefix}"/cuda --silent
