...
# applicable
#
URL: https://developer.nvidia.com/compute/cuda/11.0/Prod/local_installers/cuda_11.0.3_450.51.06_linux.run
Source: %{name}_%{version}_450.51.06_linux.run
...
%{_topdir}/SOURCES/%{name}_%{version}_450.51.06_linux.run --toolkit --toolkitpath="%{_prefix}"/cuda --samples --samplespath="%{_prefix}"/cuda/samples --silent
