...
Source: %{name}_%{version}_455.23.05_linux.run
...
%{_topdir}/SOURCES/%{name}_%{version}_455.23.05_linux.run --toolkit --toolkitpath="%{_prefix}"/cuda --samples --samplespath="%{_prefix}"/cuda/samples --silent
