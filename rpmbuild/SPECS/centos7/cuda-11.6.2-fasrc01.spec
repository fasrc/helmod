...
Source: %{name}_%{version}_510.47.03_linux.run
...
%{_topdir}/SOURCES/%{name}_%{version}_510.47.03_linux.run --toolkit --toolkitpath="%{_prefix}"/cuda --samples --samplespath="%{_prefix}"/cuda/samples --silent
