...
%{_topdir}/SOURCES/%{name}_%{version}_375.26_linux.run -toolkit -toolkitpath="%{_prefix}" -silent
%{_topdir}/SOURCES/%{name}_%{version}.2_linux.run --installdir="%{_prefix}" --silent --accept-eula 
