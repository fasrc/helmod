...
Source: %{name}_%{version}_396.26_linux.run
Source1: %{name}_%{version}.1_linux.run
...
%{_topdir}/SOURCES/%{name}_%{version}_396.26_linux.run -toolkit -toolkitpath="%{_prefix}" -silent
