...
# applicable
#
URL: https://developer.nvidia.com/compute/machine-learning/cudnn/secure/v6/prod/7.5_20170307/cudnn-7.5-linux-x64-v6.0-tgz
Source: cudnn-7.5-linux-x64-v6.0.tgz
...
%define builddependencies cuda/7.5.18-fasrc01
...
rm -rf cuda
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/%{name}-7.5-linux-x64-v6.0.tgz
cd cuda
