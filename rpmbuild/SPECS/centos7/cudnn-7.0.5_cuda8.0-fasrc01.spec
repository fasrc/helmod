...
# applicable
#
URL: https://developer.nvidia.com/compute/machine-learning/cudnn/secure/v7.0.5/prod/8.0_20171129/cudnn-8.0-linux-x64-v7
Source: cudnn-8.0-linux-x64-v7.tgz
...
%define builddependencies cuda/8.0.61-fasrc01 
%define rundependencies %{builddependencies}
%define buildcomments x86-64 binary built against cuda 8.0
...
rm -rf cuda
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/%{name}-8.0-linux-x64-v7.tgz
cd cuda
