...
# applicable
#
URL: https://developer.nvidia.com/compute/machine-learning/cudnn/secure/v7.0.5/prod/9.1_20171129/cudnn-9.1-linux-x64-v7
Source: cudnn-9.1-linux-x64-v7.tgz
...
%define builddependencies cuda/9.1.85-fasrc01 
%define rundependencies %{builddependencies}
%define buildcomments x86-64 binary built against cuda 9.1
...
rm -rf cuda
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/%{name}-9.1-linux-x64-v7.tgz
cd cuda
