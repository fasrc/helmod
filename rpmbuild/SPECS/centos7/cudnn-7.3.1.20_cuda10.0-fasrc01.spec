...
Source: cudnn-10.0-linux-x64-v7.3.1.20.tgz 
...
%define buildcomments x86-64 binary built against cuda 10
...
rm -rf cuda
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/%{name}-10.0-linux-x64-v7.3.1.20.tgz
cd cuda
