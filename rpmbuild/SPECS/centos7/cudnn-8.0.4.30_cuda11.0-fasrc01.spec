...
Source: cudnn-11.0-linux-x64-v8.0.4.30.tar.gz
...
%define builddependencies cuda/11.0.3-fasrc01
%define rundependencies %{builddependencies}
%define buildcomments x86-64 binary built against cuda 11.0.3
...
rm -rf cuda
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/%{name}-11.0-linux-x64-v8.0.4.30.tar.gz
cd cuda
