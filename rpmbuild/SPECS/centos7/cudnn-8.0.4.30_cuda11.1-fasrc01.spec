...
Source: cudnn-11.1-linux-x64-v8.0.4.30.tgz
...
%define builddependencies cuda/11.1.0-fasrc01
%define rundependencies %{builddependencies}
%define buildcomments x86-64 binary built against cuda 11.1
...
rm -rf cuda
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/%{name}-11.1-linux-x64-v8.0.4.30.tgz
cd cuda
