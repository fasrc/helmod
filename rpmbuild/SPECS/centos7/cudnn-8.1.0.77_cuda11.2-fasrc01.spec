...
Source: cudnn-11.2-linux-x64-v8.1.0.77.tgz
...
%define buildcomments x86-64 binary built against cuda 11.2
...
rm -rf cuda
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/%{name}-11.2-linux-x64-v8.1.0.77.tgz
cd cuda
