...
Source: cudnn-11.4-linux-x64-v8.2.2.26.tgz
...
%define builddependencies cuda/11.4.2-fasrc01
...
rm -rf cuda
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/%{name}-11.4-linux-x64-v8.2.2.26.tgz
cd cuda
