...
#
%define summary_static cytoscape version 3.8.2
...
%define builddependencies jdk/11.0.12-fasrc01
...
prepend_path("PATH",               "%{_prefix}/framework/bin")
prepend_path("LD_LIBRARY_PATH",    "%{_prefix}/framework/lib")
prepend_path("LIBRARY_PATH",       "%{_prefix}/framework/lib")
EOF
