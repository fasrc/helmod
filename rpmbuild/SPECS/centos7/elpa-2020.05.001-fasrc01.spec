...
#
%define summary_static Eigenvalue SoLvers for Petaflop-Applications
...
export FC=mpiifort
export CC=mpiicc
export SCALAPACK_LDFLAGS="-L$MKL_HOME/lib/intel64 -lmkl_scalapack_lp64 -lmkl_intel_lp64 -lmkl_sequential \
                          -lmkl_core -lmkl_blacs_intelmpi_lp64 -lpthread -lm -Wl,-rpath,$MKL_HOME/lib/intel64"
export SCALAPACK_FCFLAGS="-L$MKL_HOME/lib/intel64 -lmkl_scalapack_lp64 -lmkl_intel_lp64 -lmkl_sequential \
...
setenv("ELPA_HOME",                "%{_prefix}")
setenv("ELPA_LIB",                 "%{_prefix}/lib64")
setenv("ELPA_INCLUDE",             "%{_prefix}/include")
