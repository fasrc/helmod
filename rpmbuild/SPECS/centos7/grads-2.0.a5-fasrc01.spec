...
#
%define summary_static The Grid Analysis and Display System (GrADS) is an interactive desktop tool that is used for easy access, manipulation, and visualization of earth science data
...
setenv("GRADS_HOME",               "%{_prefix}")
setenv("GADDIR",                   "%{_prefix}/lib")
