...
%define builddependencies gc/7.6.4-fasrc01
...
setenv("GUILE_HOME",       "%{_prefix}")
setenv("GUILE_PATH",	   "%{_prefix}/bin")
setenv("GUILE_INCLUDE",    "%{_prefix}/include")
setenv("GUILE_LIB",        "%{_prefix}/lib64")
