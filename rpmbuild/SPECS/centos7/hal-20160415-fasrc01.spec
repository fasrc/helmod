...
#
%define summary_static HAL is a structure to efficiently store and index multiple genome alignments and ancestral reconstructions. 
...
%define buildcomments Built for CentOS 7.  Tarball is constructed by downloading dependendent packages into sister directories.
...
export CLAPACKPATH=`pwd`/clapack
(cd phast/src && make)
export PHAST=`pwd`/phast
...
prepend_path("PATH",                "%{_prefix}/hal/bin")
