...
#
%define summary_static HyPhy: Hypothesis testing using Phylogenies (pthreads version- HyPhyMP)
...
%define requestor Sangeet Lamichhaney <slamichhaney@fas.harvard.edu>
%define requestref RCRT:128526
