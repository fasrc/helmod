...
#
%define summary_static Intel Cluster Studio XE 2019: Compilers, Libraries and HPC Tools
...
setenv("INTEL_HOME",                "/n/sw/intel-cluster-studio-2019")
setenv("INTEL_LIB",                 "/n/sw/intel-cluster-studio-2019/compilers_and_libraries_2019.5.281/linux/compiler/lib/intel64")
setenv("INTEL_LICENSE_FILE",        "/n/sw/intel-cluster-studio-2019/license.lic")
setenv("INTEL_COMPOSER_INCLUDE",    "/n/sw/intel-cluster-studio-2019/compilers_and_libraries_2019.5.281/linux/compiler/include")
setenv("MKL_HOME",                  "/n/sw/intel-cluster-studio-2019/mkl")
setenv("TBB_HOME",                  "/n/sw/intel-cluster-studio-2019/tbb")
prepend_path("PATH",                "/n/sw/intel-cluster-studio-2019/compilers_and_libraries_2019.5.281/linux/bin/intel64")
prepend_path("LD_LIBRARY_PATH",     "/n/sw/intel-cluster-studio-2019/compilers_and_libraries_2019.5.281/linux/compiler/lib/intel64")
prepend_path("LD_LIBRARY_PATH",     "/n/sw/intel-cluster-studio-2019/mkl/lib/intel64")
prepend_path("LD_LIBRARY_PATH",     "/n/sw/intel-cluster-studio-2019/tbb/lib/intel64")
prepend_path("LIBRARY_PATH",        "/n/sw/intel-cluster-studio-2019/compilers_and_libraries_2019.5.281/linux/compiler/lib/intel64")
prepend_path("LIBRARY_PATH",        "/n/sw/intel-cluster-studio-2019/mkl/lib/intel64")
prepend_path("LIBRARY_PATH",        "/n/sw/intel-cluster-studio-2019/tbb/lib/intel64")
prepend_path("MANPATH",             "/n/sw/intel-cluster-studio-2019/man/common")

---- Support for starting vtune, etc.  Just source the appropriate vars.sh
prepend_path("PATH",                "/n/sw/intel-cluster-studio-2019/vtune_amplifier")
prepend_path("PATH",                "/n/sw/intel-cluster-studio-2019/inspector")
prepend_path("PATH",                "/n/sw/intel-cluster-studio-2019/advisor")
