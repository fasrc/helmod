...
#
%define summary_static InterProScan
...
setenv("INTERPROSCAN_HOME",       "/n/sw/interproscan/interproscan-5.30-69.0")

prepend_path("PATH",              "/n/sw/interproscan/interproscan-5.30-69.0")
EOF
