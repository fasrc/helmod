...
%define builddependencies  cmake/3.5.2-fasrc01 eigen/3.3.4-fasrc02
...
cmake -DCMAKE_INSTALL_PREFIX=%{_prefix} -DCMAKE_INCLUDE_PATH=$EIGEN_INCLUDE  -DIQTREE_FLAGS=omp-mpi -DCMAKE_C_COMPILER=mpicc -DCMAKE_CXX_COMPILER=mpicxx ..
make -j4
