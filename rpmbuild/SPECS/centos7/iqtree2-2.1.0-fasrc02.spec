...
cmake -DCMAKE_INSTALL_PREFIX=%{_prefix} -DEIGEN3_INCLUDE_DIR=$EIGEN_INCLUDE -DCMAKE_INCLUDE_PATH=$EIGEN_INCLUDE  -DIQTREE_FLAGS=omp-mpi -DCMAKE_C_COMPILER=mpicc -DCMAKE_CXX_COMPILER=mpicxx ..
make -j4
