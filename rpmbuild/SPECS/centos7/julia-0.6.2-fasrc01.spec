...
%define builddependencies cmake/3.5.2-fasrc01 python/2.7.14-fasrc01 gcc/7.1.0-fasrc01 OpenBLAS/0.2.20-fasrc01 
%define rundependencies python/2.7.14-fasrc01 OpenBLAS/0.2.20-fasrc01 
...
tar -xvf julia-0.6.2-full.tar.gz
