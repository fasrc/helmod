...
%define builddependencies cmake/3.5.2-fasrc01 fftw/3.3.7-fasrc01 ffmpeg/2.7.2-fasrc01
...
cmake -C ../cmake/presets/all_on.cmake -DCMAKE_INSTALL_PREFIX=%{_prefix} ../cmake 
