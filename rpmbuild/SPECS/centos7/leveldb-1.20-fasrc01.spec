...
%define builddependencies snappy/1.1.7-fasrc01
...
cp -r out-static  %{buildroot}/%{_prefix}/bin
cp -r out-shared  %{buildroot}/%{_prefix}/lib
cp out-static/libmemenv.a out-static/libleveldb.a %{buildroot}/%{_prefix}/lib
...
setenv("LEVELDB_LIB",              "%{_prefix}/lib")
