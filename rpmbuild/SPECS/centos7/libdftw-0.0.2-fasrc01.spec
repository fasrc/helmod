...
%define builddependencies libcircle/0.2.1.rc.1-fasrc01
...
setenv("LIBDFTW_HOME",       "%{_prefix}")
setenv("LIBDFTW_INCLUDE",    "%{_prefix}/include")
setenv("LIBDFTW_LIB",        "%{_prefix}/lib64")
