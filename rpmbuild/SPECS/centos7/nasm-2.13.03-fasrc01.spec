...
#
%define summary_static The Netwide Assembler, NASM, is an 80x86 and x86-64 assembler designed for portability and modularity.
...
# for whatever reason for this software make install DESTDIR did not work , so doing it manually as it's only a couple of files."
mkdir -p %{buildroot}/%{_prefix}/bin
mkdir -p %{buildroot}/%{_prefix}/share/man/man1
/usr/bin/install -c nasm %{buildroot}/%{_prefix}/bin/nasm
/usr/bin/install -c ndisasm %{buildroot}/%{_prefix}/bin/ndisasm
/usr/bin/install -c -m 644 ./nasm.1 %{buildroot}/%{_prefix}/share/man/man1/nasm.1
/usr/bin/install -c -m 644 ./ndisasm.1 %{buildroot}/%{_prefix}/share/man/man1/ndisasm.1
