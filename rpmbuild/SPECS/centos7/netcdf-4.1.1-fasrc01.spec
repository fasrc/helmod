...
#
%define summary_static NetCDF version 4.1.1 needed for some legacy applications
...
Note this is the last version where Fortran/C/C++ are all in the same place
