...
# applicable
#
URL: ftp://ftp.unidata.ucar.edu/pub/netcdf/netcdf-c-4.8.1.tar.gz
...
%define builddependencies hdf5/1.10.7-fasrc04
...
LDFLAGS=-L${HDF5_LIB} FC=pgfortran F77=pgf77 F90=pgf90 CC=pgcc CXX=pgc++ ./configure --prefix=%{_prefix} \
	--program-prefix= \
	--exec-prefix=%{_prefix} \
	--bindir=%{_prefix}/bin \
