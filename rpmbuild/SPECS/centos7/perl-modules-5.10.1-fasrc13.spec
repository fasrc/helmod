...
#
%description
Built against the fasrc05 release of perl-5.10.1.  There is a lot of stuff here including the following:
%{MODULES} %{BUILDPL}
...
%define builddependencies  perl/5.10.1-fasrc05 
