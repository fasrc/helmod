...
#
%define summary_static Prokka is a software tool for the rapid annotation of prokaryotic genomes.
...
%define rundependencies perl/5.26.1-fasrc01 tbl2asn/25.6-fasrc01
...
mkdir -p %{buildroot}/%{_prefix}
for m in Module-Build-0.4224 Time-Piece-1.3204 XML-Simple-2.24 Digest-MD5-2.55; do
  cd %{_topdir}/BUILD
...
setenv("PROKKA_HOME",               "%{_prefix}")
prepend_path("PATH",                "%{_prefix}/bin")
prepend_path("PATH",                "%{_prefix}/binaries/common")
prepend_path("PATH",                "%{_prefix}/binaries/linux")
