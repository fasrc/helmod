...
#
%define summary_static RDP_Classifier v2.2
...
# applicable
#
URL: http://downloads.sourceforge.net/project/rdp-classifier/rdp-classifier/rdp_classifier_2.2.zip
...
setenv("RDP_JAR_PATH",              "%{_prefix}/rdp_classifier-2.2.jar")
