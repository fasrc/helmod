...
Source1: XML-Simple-2.24.tar.gz
#
...
%define rundependencies perl/5.26.1-fasrc01 hmmer/3.1b2-fasrc01
%define buildcomments Built for CentOS 7.  Repackaged source code for easier building; Added Trinotate hack (see https://trinotate.github.io/#SoftwareRequired)
...
sed -i "s@/usr/cbs/bio/bin/linux64/hmmsearch@$HMMER_HOME/bin/hmmsearch@" rnammer
# perl location (once loaded)
sed -i 's@/usr/bin/perl@/usr/bin/env perl@' rnammer


# Hack for Trinotate
sed -i 's@--cpu 1 --compat@--compat@g' core-rnammer
...
for m in XML-Simple-2.24 XML-Parser-2.36; do
    cd %{_topdir}/BUILD
