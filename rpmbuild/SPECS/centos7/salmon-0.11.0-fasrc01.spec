...
# applicable
#
URL: https://github.com/COMBINE-lab/salmon/releases/download/v0.11.0/salmon-0.11.0-linux_x86_64.tar.gz
Source: salmon-%{version}-linux_x86_64.tar.gz
...
rm -rf salmon-%{version}-linux_x86_64
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/salmon-%{version}-linux_x86_64.tar.*
cd salmon-%{version}-linux_x86_64
...
umask 022
cd "$FASRCSW_DEV"/rpmbuild/BUILD/salmon-%{version}-linux_x86_64
...
setenv("SALMON_PATH",		 "%{_prefix}/bin")
setenv("SALMON_LIBRARY",	 "%{_prefix}/lib")
