...
%define buildcomments This build contains files for ArtRepair (https://cibsr.stanford.edu/tools/human-brain-project/artrepair-software.html)
...
unzip "$FASRCSW_DEV"/rpmbuild/SOURCES/ArtRepair_v5b3.zip
