...
#
%define summary_static Totalview 2019 Dynamic source code and memory debugging for C, C++ and Fortran applications.
...
#
%description
Totalview 2019 Dynamic source code and memory debugging for C, C++ and Fortran applications.
...
prepend_path("PATH",                "/n/sw/helmod/apps/centos7/Core/totalview/2019.0.4-fasrc01/toolworks/totalview.2019.0.4/bin")
EOF
