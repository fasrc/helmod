...
#
%define summary_static WebLogo is a web based application designed to make the generation of sequence logos as easy and painless as possible. 
...
%define buildcomments Built for CentOS 7. Built for use with Homer
