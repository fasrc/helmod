...
#
%define summary_static clearcut version 1.0.9
...
by J. Evans, L. Sheneman, and J. Foster from the Initiative for Bioinformatics and 
Evolutionary Studies (IBEST) at the University of Idaho.
...
rsync -av %{_topdir}/BUILD/%{name}-%{version}/include %{buildroot}/%{_prefix}/
