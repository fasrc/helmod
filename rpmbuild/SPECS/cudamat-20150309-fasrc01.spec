...
#
%define summary_static CUDAMAT version 20150309
...
#
%description
CUDAMAT is a Python module for performing basic dense linear algebra computations on the GPU using CUDA. 
...
rm -rf %{name}-%{version}
git clone --depth 1 https://github.com/cudamat/cudamat.git %{name}-%{version}
cd %{name}-%{version}
git reset --hard af7d9cabf39b9232d3f5aac648a721fd54ea9acc
