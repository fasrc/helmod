...
# applicable
#
URL: https://developer.nvidia.com/rdp/assets/cudnn-65-linux-r1
...
%define rundependencies cuda/6.5-fasrc01
%define buildcomments x86-64 binary built against cuda 6.5 using R1 of cudnn
%define requestor Grace Huckins <>
...
rm -rf cudnn-6.5-linux-R1
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/cudnn-6.5-linux-R1.tgz
...
umask 022
cd "$FASRCSW_DEV"/rpmbuild/BUILD/cudnn-6.5-linux-R1
...
setenv("CUDNN_LIB",                 "%{_prefix}")
setenv("CUDNN_INCLUDE",             "%{_prefix}")
