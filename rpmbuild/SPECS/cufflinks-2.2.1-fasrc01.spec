...
export CFLAGS="-I$EIGEN_INCLUDE/eigen3 $CFLAGS"
echo "samtools: $SAMTOOLS_HOME"
echo "libpath1: $LD_LIBRARY_PATH"
echo "libpath2: $LIBRARY_PATH"
#export LIBS=/n/sw/fasrcsw/apps/Core/samtools/1.1-fasrc02/lib:$LIBS
export CXXFLAGS="-L$SAMTOOLS_HOME/lib -I$HTSLIB_INCLUDE -L$HTSLIB_LIB $CXXFLAGS"
...
./configure --prefix=%{_prefix} \
    ...
    --with-bam=/n/sw/fasrcsw/apps/Core/samtools/1.1-fasrc02 \
	--program-prefix= \
	--exec-prefix=%{_prefix} \
	--bindir=%{_prefix}/bin \
	...
	--includedir=%{_prefix}/include:$BAMROOT/lib \
	--libdir=%{_prefix}/lib64:$BAMROOT/lib \
