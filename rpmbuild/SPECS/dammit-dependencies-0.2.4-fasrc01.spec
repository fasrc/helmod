...
#
%define summary_static Dependencies for dammit, a simple de novo transcriptome annotator. 
...
#
%description
Dependencies for the dammit annotator
...
setenv("DAMMIT_DEPENDENCIES_HOME",       "%{_prefix}") 
EOF
