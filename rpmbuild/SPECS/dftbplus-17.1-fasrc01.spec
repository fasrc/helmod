...
#
%define summary_static DFTB+ is an  implementation of the Density Functional based Tight Binding (DFTB) method
...
# applicable
#
URL: http://www.dftbplus.org/download/dftb-171/
...
sed -i  's/ARPACK_LIBS :=.*/ARPACK_LIBS := \/n\/sw\/fasrcsw\/apps\/Comp\/intel\/15.0.0-fasrc01\/arpack\/96-fasrc01\/lib\/libarpack.a/' make.config
...
setenv("DFTBPLUS_HOME",            "%{_prefix}")
prepend_path("PATH",               "%{_prefix}/bin")
prepend_path("LD_LIBRARY_PATH",    "%{_prefix}/lib")
prepend_path("LIBRARY_PATH",       "%{_prefix}/lib")
prepend_path("PYTHONPATH",         "%{_prefix}/lib/python2.6/site-packages")
EOF
