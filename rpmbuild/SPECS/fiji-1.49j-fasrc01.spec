...
#
%define summary_static Fiji 1.49j
...
%define rundependencies %{builddependencies}  %{nil}
...
%define apptags aci-ref-app-category:Applications; aci-ref-app-tag:Image processing
...
setenv("FIJI_HOME",                "%{_prefix}")
prepend_path("PATH",               "%{_prefix}")
prepend_path("JAVA_OPTS",          "-Djava.library.path=%{_prefix}")
