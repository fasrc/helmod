...
software -- libcircle/libdftw (for the map) and libmrmpi (for the 
...
module load libcircle/0.2.0.rc.1-fasrc02
module load libdftw/0.0.2-fasrc01
module load mrmpi/7Apr14-fasrc01
...
if mode()=="load" then
	if not isloaded("libdftw") then
		load("libdftw/0.0.2-fasrc01")
		--this will pull in libcircle/0.2.0.rc.1-fasrc02
	end
end
if mode()=="load" then
	if not isloaded("mrmpi") then
		load("mrmpi/7Apr14-fasrc01")
	end
end
