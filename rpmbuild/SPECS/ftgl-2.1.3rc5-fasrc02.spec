...
#
%define summary_static FTGL is a free cross-platform Open Source C++ library that uses Freetype2 to simplify rendering fonts in OpenGL applications. 
...
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/ftgl-2.1.3-rc5.tar.gz
cd ftgl-2.1.3~rc5
...
umask 022
cd "$FASRCSW_DEV"/rpmbuild/BUILD/ftgl-2.1.3~rc5
...
setenv("FTGL_HOME",                "%{_prefix}")
setenv("FTGL_INCLUDE",             "%{_prefix}/include")
setenv("FTGL_LIB",                 "%{_prefix}/lib64")
