...
#
%define summary_static C  library for working with the GRIB2 format
...
sed -i -e 's?^INC.*?INC=-I$JASPER_INCLUDE?' makefile
...
cp libgrib2c.a %{buildroot}/%{_prefix}/lib
...
setenv("G2CLIB_HOME",         "%{_prefix}")
setenv("G2CLIB_LIB",          "%{_prefix}/lib")
setenv("G2CLIB_INCLUDE",      "%{_prefix}/include")
