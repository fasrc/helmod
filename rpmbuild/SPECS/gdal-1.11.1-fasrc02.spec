...
%define buildcomments This build is specifically for NCL and is based on the instructions found here: (http://www.ncl.ucar.edu/Download/build_from_src.shtml#BuildOptionalSoftware)
...
#
%description
Build comments: %{buildcomments} Gdal is a translator library for raster and vector geospatial data formats that is released under an X/MIT style Open Source license by the Open Source Geospatial Foundation. As a library, it presents a single raster abstract data model and vector abstract data model to the calling application for all supported formats. It also comes with a variety of useful commandline utilities for data translation and processing. The NEWS page describes the September 2014 GDAL/OGR 1.11.1 release.
