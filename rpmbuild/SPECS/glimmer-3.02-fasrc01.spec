...
#
%define summary_static Glimmer is a system for finding genes in microbial DNA, especially the genomes of bacteria, archaea, and viruses. 
...
rm -rf %{name}%{version}
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/glimmer302b.tar.gz
cd %{name}%{version}
