...
#
%define summary_static Grace is a WYSIWYG 2D plotting tool for the X Window System and M*tif. 
...
# applicable
#
URL: ftp://plasma-gate.weizmann.ac.il/pub/grace/src/grace5/grace-5.1.25.tar.gz
...
%define requestor Tom Jones <thomasjones@fas.harvard.edu>
%define requestref RCRT:98967
...
setenv("GRACE_HOME",                "%{_prefix}/grace")
setenv("GRACE_LIB",                 "%{_prefix}/grace/lib")
setenv("GRACE_INCLUDE",             "%{_prefix}/grace/include")
prepend_path("PATH",                "%{_prefix}/grace/bin")
EOF
