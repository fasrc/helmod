...
# applicable
#
URL: http://gstreamer.freedesktop.org/src/gst-plugins-base/gst-plugins-base-0.10.30.tar.gz
...
setenv("GST_PLUGINS_BASE_INCLUDE", "%{_prefix}/include")
setenv("GST_PLUGINS_BASE_LIB",     "%{_prefix}/lib64")
