...
%define buildcomments Tarball is constructed by downloading dependendent packages into sister directories.
%define requestor Nate Edelman <nedelman@g.harvard.edu>
