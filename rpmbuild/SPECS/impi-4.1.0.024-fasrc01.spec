...
%define requestor Raymond Norris <Raymond.Norris@mathworks.com>
...
setenv("MPI_HOME",                 "/n/sw/intel_cluster_studio-2013/impi-4.1.0.024/intel64")
setenv("MPI_INCLUDE",              "/n/sw/intel_cluster_studio-2013/impi-4.1.0.024/intel64/include")
setenv("MPI_LIB",                  "/n/sw/intel_cluster_studio-2013/impi-4.1.0.024/intel64/lib")
prepend_path("PATH",               "/n/sw/intel_cluster_studio-2013/impi-4.1.0.024/intel64/bin")
prepend_path("CPATH",              "/n/sw/intel_cluster_studio-2013/impi-4.1.0.024/intel64/include")
prepend_path("FPATH",              "/n/sw/intel_cluster_studio-2013/impi-4.1.0.024/intel64/include")
prepend_path("LD_LIBRARY_PATH",    "/n/sw/intel_cluster_studio-2013/impi-4.1.0.024/intel64/lib")
prepend_path("LIBRARY_PATH",       "/n/sw/intel_cluster_studio-2013/impi-4.1.0.024/intel64/lib")
