...
%define vcs_commit c61d075abcc17fd87532688898577c6a1c0785e9
...
#
%define summary_static Keras %{version} built from git commit %{vcs_commit}
...
%define rundependencies %{builddependencies} cuda/7.5-fasrc01 theano/20160126-fasrc01
...
rm -rf %{name}-%{version}
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/%{vcs_commit}.tar.gz
mv %{name}-%{vcs_commit} %{name}-%{version}
cd %{name}-%{version}
