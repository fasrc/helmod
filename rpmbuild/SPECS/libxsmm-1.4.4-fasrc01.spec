...
#
%define summary_static Library targeting Intel Architecture (x86) for small dense and sparse matrix multiplications as well as small convolutions.
...
# applicable
#
URL: https://github.com/hfp/libxsmm/archive/1.4.4.tar.gz
