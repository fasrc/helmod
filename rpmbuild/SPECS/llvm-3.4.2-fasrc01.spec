...
# applicable
#
URL: http://llvm.org/releases/3.4.2/llvm-3.4.2.src.tar.xz
Source0: %{name}-%{version}.src.tar.gz
Source1: cfe-3.4.2.src.tar.gz
Source2: compiler-rt-3.4.2.src.tar.gz
...
%define buildcomments Needed to turn on shared library build for Mesa
%define requestor Huiliang Zhang01 <hzhang01@fas.harvard.edu>
%define requestref RCRT:84932
...
cp -r compiler-rt-3.4  %{name}-%{version}.src/projects/compiler-rt
cd %{name}-%{version}.src
