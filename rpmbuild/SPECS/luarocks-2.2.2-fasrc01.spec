...
#
%define summary_static Package manager for Lua
...
%define requestor Alexander Rush  <srush@seas.harvard.edu>
%define requestref RCRT:89900

# apptags
# For aci-ref database use aci-ref-app-category and aci-ref-app-tag namespaces and separate tags with a semi-colon
# aci-ref-app-category:Programming Tools; aci-ref-app-tag:Compiler
%define apptags   aci-ref-app-category:Programming Tools; aci-ref-app-tag:Package manager
