...
#
%define summary_static a computational software program used in many scientific, engineering, mathematical and computing fields, based on symbolic mathematics
...
prepend_path("PATH", "/n/sw/mathematica-9.0.1")
EOF
