...
%define builddependencies libctl/3.2.2-fasrc01 hdf5/1.8.12-fasrc08 fftw/3.3.4-fasrc09 guile/1.8.8-fasrc01 libtool/2.4.6-fasrc01
%define rundependencies libctl/3.2.2-fasrc01 hdf5/1.8.12-fasrc08 fftw/3.3.4-fasrc09 guile/1.8.8-fasrc01
...
./configure --prefix=%{_prefix} --with-mpi --with-openmp --enable-shared --with-libctl=${LIBCTL_HOME}/share/libctl 
#	--program-prefix= \
#	--exec-prefix=%{_prefix} \
#	--bindir=%{_prefix}/bin \
