...
#
%define summary_static medical image viewer
...
# applicable
#
URL: http://www.mccauslandcenter.sc.edu/mricro/mricro/mricro.html
#wget http://www.mccauslandcenter.sc.edu/mricro/mricro/mricrox.tar.gz -O mricro-1.39.build3.tar.gz
