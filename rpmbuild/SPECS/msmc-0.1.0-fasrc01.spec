...
# applicable
#
URL: https://github.com/stschiff/msmc/archive/v0.1.0.tar.gz
...
%define builddependencies d/2.071.0-fasrc01 gsl/1.16-fasrc02
...
cd %{name}
git checkout a9d0e20fc44681a89decb57173fae6c6770d7f80
...
sed -i -e 's?^GSL.*?GSL = ${GSL_LIB}/libgsl.a ${GSL_LIB}/libgslcblas.a?' Makefile
make
...
cp -r build/* %{buildroot}/%{_prefix}/bin
