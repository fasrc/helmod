...
%define builddependencies cuda/7.5-fasrc02 tcl/8.6.4-fasrc01 charm_verbs/6.7.1-fasrc01 fftw/3.3.4-fasrc09
...
./config Linux-x86_64-g++  --with-cuda --with-fftw3 --with-tcl --charm-arch verbs-linux-x86_64
cd Linux-x86_64-g++
