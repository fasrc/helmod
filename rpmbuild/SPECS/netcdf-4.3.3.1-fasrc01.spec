...
%define builddependencies hdf5/1.8.12-fasrc04 zlib/1.2.8-fasrc03 hdf/4.2.11-fasrc01 szip/2.1-fasrc01
%define rundependencies %{builddependencies}
%define buildcomments Build of netcdf following NCL/NCAR instructions from here: (http://www.ncl.ucar.edu/Download/build_from_src.shtml#BuildOptionalSoftware).  Specifically netcdf-4 and szlib are included.
...
# Without explicit JPEG, the HDF4 fails
export CFLAGS="-I${HDF4_INCLUDE} -I${JPEG_INCLUDE}"
export LDFLAGS="-L${HDF5_INCLUDE} -L${JPEG_LIB} -ljpeg"
