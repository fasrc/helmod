...
%define builddependencies zlib/1.2.8-fasrc08  gsl/1.16-fasrc03
%define rundependencies %{builddependencies}
%define buildcomments %{nil}
%define requestor Allison Schultz <ashultz@fas.harvard.edu>
%define requestref RCRT:109599
...
$CXX ngsRelate.cpp -O3 -lz -o ngsRelate
