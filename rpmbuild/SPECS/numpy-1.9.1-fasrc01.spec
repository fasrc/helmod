...
#
%define summary_static NumPy version 1.9.1
...
#
%description
NumPy is the fundamental package for scientific computing with Python. This module has been built with Intel compiler and MKL by Plamen G. Krastev.
...
load("Cython/0.22-fasrc01")
load("intel/15.0.0-fasrc01")
load("intel-mkl/11.0.0.079-fasrc02")
