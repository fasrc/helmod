...
#
%define summary_static Audio codecs extracted from Android Open Source Project
...
setenv("OPENCOREAMR_HOME",         "%{_prefix}")
setenv("OPENCOREAMR_INCLUDE",      "%{_prefix}/include")
setenv("OPENCOREAMR_LIB",          "%{_prefix}/lib64")
