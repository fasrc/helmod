...
#
%define summary_static Opus is a totally open, royalty-free, highly versatile audio codec.
...
setenv("OPUS_HOME",                "%{_prefix}")
setenv("OPUS_INCLUDE",             "%{_prefix}/include")
setenv("OPUS_LIB",                 "%{_prefix}/lib64")
