...
#
%define summary_static Given a file containing a list of unix commands, multithreading is used to process the commands in parallel on a single server.
...
# applicable
#
URL: https://downloads.sourceforge.net/project/parafly/parafly-r2013-01-21.tgz
