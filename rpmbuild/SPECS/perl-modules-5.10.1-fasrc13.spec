...
#
%description
Built against the fasrc04 release of perl-5.10.1, which includes threads.  There is a lot of stuff here including the following:
%{MODULES} %{BUILDPL}
