...
if [ "%{comp_name}" == "intel" ] 
then
    ./configure --prefix=%{_prefix} --download-superlu_dist --download-mumps --download-pastix --download-parmetis --download-metis --download-ptscotch --download-scalapack --with-blas-lapack-dir=$MKL_HOME

else
    ./configure --prefix=%{_prefix} --download-superlu_dist --download-mumps --download-pastix --download-parmetis --download-metis --download-ptscotch --download-scalapack
