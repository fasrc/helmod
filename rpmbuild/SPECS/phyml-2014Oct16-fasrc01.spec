...
#
%define summary_static PhyML is a software that estimates maximum likelihood phylogenies from alignments of nucleotide or amino acid sequences. 
...
# applicable
#
# git cloned repository on Oct 16 2014 and created tarball
...
setenv("PHYML_HOME",               "%{_prefix}")
setenv("PHYML_LIB",                "%{_prefix}/lib64")
