...
#
%define summary_static Python API for the GTK graphic library
...
# applicable
#
URL: http://ftp.gnome.org/pub/GNOME/sources/pygtk/2.12/pygtk-2.12.1.tar.gz
