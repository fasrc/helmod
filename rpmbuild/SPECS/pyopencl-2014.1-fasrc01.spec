...
#
%define summary_static PyOpenCL version 2014.1
...
NOTE: This module is built spicifically to work on the resonance (seasgpu** nodes) cluster.
...
### Here we install the binaries only ###
echo %{buildroot} | grep -q %{name}-%{version} && rm -rf %{buildroot}
mkdir -p %{buildroot}/%{_prefix}
