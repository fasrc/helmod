...
%define buildcomments Building with SSE3 instructions.  Comp only, no MPI
%define requestor Taunha Cunha <tauanacunha@g.harvard.edu>
%define requestref RCRT:112111
...
MAKEFILES="Makefile.gcc Makefile.SSE3.PTHREADS.gcc Makefile.SSE3.gcc"
