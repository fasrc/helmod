...
# applicable
#
URL: https://github.com/conda-forge/miniforge/releases/download/22.11.1-4/Mambaforge-22.11.1-4-Linux-x86_64.sh
...
# Installed this package by hand to /n/sw/Mambaforge-22.11.1-4 using:
# bash Mambaforge-22.11.1-4-Linux-x86_64.sh -b -p /n/sw/Mambaforge-22.11.1-4
