...
local root = pathJoin("/n/sw/Miniforge3-24.11.3-0")
...
setenv("PYTHON_HOME",               "/n/sw/Miniforge3-24.11.3-0/")
setenv("PYTHON_INCLUDE",            "/n/sw/Miniforge3-24.11.3-0/include")
setenv("PYTHON_LIB",                "/n/sw/Miniforge3-24.11.3-0/lib")
setenv("PIP_NO_CACHE_DIR",          "off")
setenv("MAMBA_DISABLE_LOCKFILE",    "1")
setenv("PYTHONNOUSERSITE",          "True")
setenv("CONDA_PKGS_DIRS",           "~/.conda/pkgs")
prepend_path("PATH",                "/n/sw/Miniforge3-24.11.3-0/bin")
EOF
