...
#
%define summary_static Miniforge Python Implementation with JupyterLab
...
# add JupyterLab:
#module load python
#mamba activate /n/sw/Miniforge3-<version>
#mamba install jupyterlab nb_conda_kernels -y
#
...
local root = pathJoin("/n/sw/Miniforge3-24.11.3-0-fasrc02")
...
setenv("PYTHON_HOME",               "/n/sw/Miniforge3-24.11.3-0-fasrc02/")
setenv("PYTHON_INCLUDE",            "/n/sw/Miniforge3-24.11.3-0-fasrc02/include")
setenv("PYTHON_LIB",                "/n/sw/Miniforge3-24.11.3-0-fasrc02/lib")
setenv("PIP_NO_CACHE_DIR",          "off")
setenv("MAMBA_DISABLE_LOCKFILE",    "1")
setenv("PYTHONNOUSERSITE",          "True")
setenv("CONDA_PKGS_DIRS",           "~/.conda/pkgs")
prepend_path("PATH",                "/n/sw/Miniforge3-24.11.3-0-fasrc02/bin")
EOF
