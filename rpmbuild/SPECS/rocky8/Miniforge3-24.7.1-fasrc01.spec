...
# applicable
#
URL: https://github.com/conda-forge/miniforge/releases/download/24.7.1-0/Miniforge3-24.7.1-0-Linux-x86_64.sh
...
#bash Miniforge3-24.7.1-0-Linux-x86_64.sh -b -p /n/sw/Miniforge3-24.7.1-0
...
local root = pathJoin("/n/sw/Miniforge3-24.7.1-0")
...
setenv("PYTHON_HOME",               "/n/sw/Miniforge3-24.7.1-0/")
setenv("PYTHON_INCLUDE",            "/n/sw/Miniforge3-24.7.1-0/include")
setenv("PYTHON_LIB",                "/n/sw/Miniforge3-24.7.1-0/lib")
setenv("PIP_NO_CACHE_DIR",          "off")
setenv("MAMBA_DISABLE_LOCKFILE",    "1")
setenv("PYTHONNOUSERSITE",          "True")
setenv("CONDA_PKGS_DIRS",           "~/.conda/pkgs")
prepend_path("PATH",                "/n/sw/Miniforge3-24.7.1-0/bin")
EOF
