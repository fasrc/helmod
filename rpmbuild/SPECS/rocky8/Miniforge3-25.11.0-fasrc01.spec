...
# Installed this package by hand to /n/sw/Mambaforge-25.11.0-0 using:
#bash Miniforge3-25.11.0-1-Linux-x86_64.sh -b -p /n/sw/Miniforge3-25.11.0-1
# As root.
# In addition you will want to update /n/sw/Miniforge3-25.11.0-0/.condarc
...
setenv("PYTHON_HOME",               "/n/sw/Miniforge3-25.11.0-1/")
setenv("PYTHON_INCLUDE",            "/n/sw/Miniforge3-25.11.0-1/include")
setenv("PYTHON_LIB",                "/n/sw/Miniforge3-25.11.0-1/lib")
setenv("MAMBA_ROOT_PREFIX",         "/n/sw/Miniforge3-25.11.0-1/")
setenv("PIP_NO_CACHE_DIR",          "off")
setenv("MAMBA_DISABLE_LOCKFILE",    "1")
setenv("PYTHONNOUSERSITE",          "True")
prepend_path("PATH",                "/n/sw/Miniforge3-25.11.0-1/bin")
