...
setenv("PYTHON_HOME",               "/n/sw/Miniforge3-26.1.0-0/")
setenv("PYTHON_INCLUDE",            "/n/sw/Miniforge3-26.1.0-0/include")
setenv("PYTHON_LIB",                "/n/sw/Miniforge3-26.1.0-0/lib")
setenv("MAMBA_ROOT_PREFIX",         "/n/sw/Miniforge3-26.1.0-0/")
setenv("PIP_NO_CACHE_DIR",          "off")
setenv("MAMBA_DISABLE_LOCKFILE",    "1")
setenv("PYTHONNOUSERSITE",          "True")
prepend_path("PATH",                "/n/sw/Miniforge3-26.1.0-0/bin")

---- Fix for conda init issues.
execute{cmd="eval \"\$(conda shell.${SHELL##*/} hook) && conda deactivate\"", modeA={"load"}}
execute{cmd="eval \"\$(mamba shell hook --shell ${SHELL##*/}) && mamba deactivate\"", modeA={"load"}}
EOF
