...
#
%define summary_static AMD Optimizing C/C++ and Fortran Compilers
...
setenv("AOCC_LIB",        "%{_prefix}/lib")
setenv("AOCC_INCLUDE",    "%{_prefix}/include")

prepend_path("PATH",                "%{_prefix}/bin")
prepend_path("PATH",                "%{_prefix}/share/opt-viewer")
prepend_path("CPATH",               "%{_prefix}/include")
prepend_path("FPATH",               "%{_prefix}/include")
prepend_path("LD_LIBRARY_PATH",     "%{_prefix}/lib32")
