...
Source: %{name}_%{version}_535.54.03_linux.run
...
%{_topdir}/SOURCES/%{name}_%{version}_535.54.03_linux.run --toolkit --toolkitpath="%{_prefix}"/cuda --samples --samplespath="%{_prefix}"/cuda/samples --silent
