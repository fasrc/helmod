...
Source: %{name}_%{version}_550.54.15_linux.run
...
%{_topdir}/SOURCES/%{name}_%{version}_550.54.15_linux.run --toolkit --toolkitpath="%{_prefix}"/cuda --samples --samplespath="%{_prefix}"/cuda/samples --silent
