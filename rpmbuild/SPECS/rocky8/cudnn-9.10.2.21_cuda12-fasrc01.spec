...
Source: cudnn-linux-x86_64-9.10.2.21_cuda12-archive.tar.xz
...
%define buildcomments x86-64 binary built against cuda 12
...
rm -rf cuda
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/cudnn-linux-x86_64-9.10.2.21_cuda12-archive.tar.xz
...
umask 022
cd "$FASRCSW_DEV"/rpmbuild/BUILD/cudnn-linux-x86_64-9.10.2.21_cuda12-archive
