...
#
%define summary_static Distributed MultiThreaded CheckPointing
...
# applicable
#
URL: https://github.com/dmtcp/dmtcp/archive/refs/tags/v4.2.0.tar.gz
...
setenv("DMTCP_HOME",       "%{_prefix}")
setenv("DMTCP_LIB",        "%{_prefix}/lib64")
setenv("DMTCP_INCLUDE",    "%{_prefix}/include")
