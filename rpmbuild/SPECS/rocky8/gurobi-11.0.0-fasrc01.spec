...
setenv("GUROBI_HOME",               "/n/sw/gurobi1100/linux64")
setenv("GUROBI_LIB",                "/n/sw/gurobi1100/linux64/lib")
setenv("GUROBI_INCLUDE",            "/n/sw/gurobi1100/linux64/include")
setenv("GRB_LICENSE_FILE",          "/n/sw/gurobi1100/linux64/gurobi.lic")
prepend_path("PATH",                "/n/sw/gurobi1100/linux64/bin")
prepend_path("CPATH",               "/n/sw/gurobi1100/lunux64/include")
prepend_path("LD_LIBRARY_PATH",     "/n/sw/gurobi1100/linux64/lib")
prepend_path("LIBRARY_PATH",        "/n/sw/gurobi1100/linux64/lib")
EOF
