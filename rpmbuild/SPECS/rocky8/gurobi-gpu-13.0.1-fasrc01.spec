...
# Source: gurobi13.0.1_linux64.tar.gz
...
setenv("GUROBI_HOME",               "/n/sw/gurobi/gurobi-gpu-13.0.1/linux64cuda12")
setenv("GUROBI_LIB",                "/n/sw/gurobi/gurobi-gpu-13.0.1/linux64cuda12/lib")
setenv("GUROBI_INCLUDE",            "/n/sw/gurobi/gurobi-gpu-13.0.1/linux64cuda12/include")
setenv("GRB_LICENSE_FILE",          "/n/sw/gurobi/gurobi-gpu-13.0.1/linux64cuda12/gurobi.lic")
prepend_path("PATH",                "/n/sw/gurobi/gurobi-gpu-13.0.1/linux64cuda12/bin")
prepend_path("CPATH",               "/n/sw/gurobi/gurobi-gpu-13.0.1/linux64cuda12/include")
prepend_path("LD_LIBRARY_PATH",     "/n/sw/gurobi/gurobi-gpu-13.0.1/linux64cuda12/lib")
prepend_path("LIBRARY_PATH",        "/n/sw/gurobi/gurobi-gpu-13.0.1/linux64cuda12/lib")
EOF
