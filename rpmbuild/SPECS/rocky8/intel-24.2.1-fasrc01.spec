...
#
%define summary_static Intel oneAPI 2024.2.1: Compilers, Libraries and HPC Tools
...
#sh ./l_BaseKit_p_2024.2.1.100.sh -a --install-dir=/n/sw/intel-oneapi-2024.2.1/ --instance=2024.2.1
#sh ./l_HPCKit_p_2024.2.1.79.sh -a --install-dir=/n/sw/intel-oneapi-2024.2.1/ --instance=2024.2.1
...
setenv("INTEL_HOME",                "/n/sw/intel-oneapi-2024.2.1")
setenv("INTEL_LIB",                 "/n/sw/intel-oneapi-2024.2.1/compiler/2024.2/lib/")
setenv("INTEL_COMPOSER_INCLUDE",    "/n/sw/intel-oneapi-2024.2.1/compiler/2024.2/include")
setenv("MKL_HOME",                  "/n/sw/intel-oneapi-2024.2.1/mkl/2024.2")
setenv("TBB_HOME",                  "/n/sw/intel-oneapi-2024.2.1/tbb/2024.2")
...
prepend_path("PATH",                "/n/sw/intel-oneapi-2024.2.1/compiler/2024.2/bin")
prepend_path("LD_LIBRARY_PATH",     "/n/sw/intel-oneapi-2024.2.1/compiler/2024.2/lib")
prepend_path("LD_LIBRARY_PATH",     "/n/sw/intel-oneapi-2024.2.1/mkl/2024.2/lib/intel64")
prepend_path("LIBRARY_PATH",        "/n/sw/intel-oneapi-2024.2.1/compiler/2024.2/lib")
prepend_path("LIBRARY_PATH",        "/n/sw/intel-oneapi-2024.2.1/tbb/2021.13/lib/intel64")

prepend_path("CPATH",               "/n/sw/intel-oneapi-2024.2.1/compiler/2024.2/include")
prepend_path("FPATH",               "/n/sw/intel-oneapi-2024.2.1/compiler/2024.2/include")

---- Support for starting vtune, inspector, advisor and sourcing respective vars.sh
prepend_path("PATH",                "/n/sw/intel-oneapi-2024.2.1/vtune/2024.2")
prepend_path("PATH",                "/n/sw/intel-oneapi-2024.2.1/advisor/2024.2")
source_sh("bash",                   "/n/sw/intel-oneapi-2024.2.1/vtune/2024.2/env/vars.sh")
source_sh("bash",                   "/n/sw/intel-oneapi-2024.2.1/advisor/2024.2/env/vars.sh")
