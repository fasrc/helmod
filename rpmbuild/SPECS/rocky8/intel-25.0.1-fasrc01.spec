...
#
%define summary_static Intel oneAPI 2025.0.1: Compilers, Libraries and HPC Tools
...
#sh ./intel-oneapi-base-toolkit-2025.0.1.46.sh -a --install-dir=/n/sw/intel-oneapi-2025.0.1/ --instance=2025.0.1
#sh ./intel-oneapi-hpc-toolkit-2025.0.1.47.sh -a --install-dir=/n/sw/intel-oneapi-2025.0.1/ --instance=2025.0.1
...
setenv("INTEL_HOME",                "/n/sw/intel-oneapi-2025.0.1")
...
prepend_path("PATH",                "/n/sw/intel-oneapi-2025.0.1/compiler/2025.0/bin")
prepend_path("LD_LIBRARY_PATH",     "/n/sw/intel-oneapi-2025.0.1/compiler/2025.0/lib")
prepend_path("LD_LIBRARY_PATH",     "/n/sw/intel-oneapi-2025.0.1/mkl/2025.0/lib/intel64")
prepend_path("LIBRARY_PATH",        "/n/sw/intel-oneapi-2025.0.1/compiler/2025.0/lib")
prepend_path("LIBRARY_PATH",        "/n/sw/intel-oneapi-2025.0.1/tbb/2022.0/lib/intel64")

prepend_path("CPATH",               "/n/sw/intel-oneapi-2025.0.1/compiler/2025.0/include")
prepend_path("FPATH",               "/n/sw/intel-oneapi-2025.0.1/compiler/2025.0/include")

---- Support for starting vtune, inspector, advisor and sourcing respective vars.sh
prepend_path("PATH",                "/n/sw/intel-oneapi-2025.0.1/vtune/2025.0")
prepend_path("PATH",                "/n/sw/intel-oneapi-2025.0.1/advisor/2025.0")
source_sh("bash",                   "/n/sw/intel-oneapi-2025.0.1/vtune/2025.0/env/vars.sh")
source_sh("bash",                   "/n/sw/intel-oneapi-2025.0.1/advisor/2025.0/env/vars.sh")
