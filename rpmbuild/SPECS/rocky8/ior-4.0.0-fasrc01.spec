...
#
%define summary_static IOR Benchmark
...
# applicable
#
URL: https://github.com/hpc/ior/releases/download/4.0.0/ior-4.0.0.tar.gz
...
./configure CC=mpicc --prefix=%{_prefix} \
	--program-prefix= \
	--exec-prefix=%{_prefix} \
	--bindir=%{_prefix}/bin \
...
setenv("IOR_HOME",       "%{_prefix}")
setenv("IOR_LIB",        "%{_prefix}/lib64")
