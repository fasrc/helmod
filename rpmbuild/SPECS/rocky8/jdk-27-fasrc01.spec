...
# applicable
#
URL: https://download.oracle.com/java/26/latest/jdk-27_linux-x64_bin.tar.gz
Source: jdk-27_linux-x64_bin.tar.gz
...
rm -rf %{name}-%{version}
tar xvf "$FASRCSW_DEV"/rpmbuild/SOURCES/jdk-27_linux-x64_bin.tar.gz
ls 
cd %{name}-%{version}
