...
#
%define summary_static libcircle is an API for distributing embarrassingly parallel workloads using self-stabilization.
...
setenv("LIBCIRLCE_HOME",       "%{_prefix}")
setenv("LIBCIRLCE_LIB",        "%{_prefix}/lib64")
setenv("LIBCIRLCE_INCLUDE",    "%{_prefix}/include")
