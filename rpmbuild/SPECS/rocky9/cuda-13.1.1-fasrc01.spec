...
Source: %{name}_%{version}_590.48.01_linux.run
...
%{_topdir}/SOURCES/%{name}_%{version}_590.48.01_linux.run --toolkit --toolkitpath="%{_prefix}"/cuda --samples --samplespath="%{_prefix}"/cuda/samples --silent
