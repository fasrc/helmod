...
#
%define summary_static SCOTCH version 6.0.0
...
# applicable
#
URL: https://gforge.inria.fr/frs/download.php/file/31831/scotch_6.0.0.tar.gz
...
cp "$FASRCSW_DEV"/rpmbuild/BUILD/%{name}-%{version}/src/Make.inc/Makefile.inc.i686_pc_linux2.shlib "$FASRCSW_DEV"/rpmbuild/BUILD/%{name}-%{version}/src/Makefile.inc
