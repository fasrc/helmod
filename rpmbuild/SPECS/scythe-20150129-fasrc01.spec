...
#
%define summary_static A 3'-end adapter contaminant trimmer
...
# applicable
#
URL: https://github.com/ucdavis-bioinformatics/scythe.git
...
cp scythe %{buildroot}/%{_prefix}/bin 
