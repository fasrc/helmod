...
#
%define summary_static setuptools version 1.4.2
...
sudo chown -R pkrastev:rc_admin "/n/sw/fasrcsw/apps/Core/setuptools"

export PYTHONPATH=/n/sw/fasrcsw/apps/Core/setuptools/1.4.2-fasrc01/lib/python2.7/site-packages:$PYTHONPATH
...
rm -r "/n/sw/fasrcsw/apps/Core/setuptools"
