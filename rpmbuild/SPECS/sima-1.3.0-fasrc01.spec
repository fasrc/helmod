...
%define builddependencies Anaconda/1.9.2-fasrc01 opencv/2.4.9-fasrc01
...
pip install --install-option="--prefix=%{buildroot}/%{_prefix}" shapely pillow future bottleneck MDP sima
