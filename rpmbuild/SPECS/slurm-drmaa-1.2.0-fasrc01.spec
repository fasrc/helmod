...
# applicable
#
URL: https://apps.man.poznan.pl/svn/slurm-drmaa 
...
%define builddependencies gperf/3.0.4-fasrc01 ragel/6.9-fasrc01
...
umask 022
cd "$FASRCSW_DEV"/rpmbuild/BUILD/%{name}/branches/%{name}-%{version}
