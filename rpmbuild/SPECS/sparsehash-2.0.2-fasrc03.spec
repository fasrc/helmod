...
#
%define summary_static An extremely memory-efficient hash_map implementation.
...
%define buildcomments Set HOME and INCLUDE environment variables
...
setenv("SPARSEHASH_HOME",          "%{_prefix}")
setenv("SPARSEHASH_INCLUDE",       "%{_prefix}/include")
