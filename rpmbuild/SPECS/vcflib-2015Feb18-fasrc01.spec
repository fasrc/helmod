...
#
%define summary_static A simple C++ library for parsing and manipulating VCF files, + many command-line utilities.
...
%define buildcomments Checked out latest from github.  Make sure and do "git clone --recursive" to get the submodules
%define requestor Lori Shapiro <lshapiro@fas.harvard.edu>
...
setenv("VCFLIB_HOME",       "%{_prefix}")
setenv("VCFLIB_LIB",        "%{_prefix}")
